			...
			<div class="col-lg-12" id="content">
				<div id="breadcrumb-div">
					<ul class="breadcrumb">
					    ...
					    <li><a href="<?=base_url('business-center/capex-info/' . $year)?>">CAPEX Info</a></li>
				...
				<div id="add-btn">
					...
					<a href="<?=base_url('business-center/add-capex-item/' . $id)?>" class="btn btn-success btn-xs">+ Add Capex Item</a>
								...
								<div class="modal-dialog modal-sm">
								    <div class="modal-content">
								    	<div class="modal-header">
								      	...
								      	<form method="POST" action="<?=base_url('business-center/remove-capex-item')?>" id="remove-capex-item">
								...
								<div class="modal-dialog" style="width:1250px;">
								    <div class="modal-content">
								    	<div class="modal-header">
								      	...
								      	<form method="POST" action="<?=base_url('business-center/update-capex-item')?>" id="update-capex-item">
								      		<input type="hidden" id="id" name="id[]">
									      	<div class="modal-body">
									      		<div class="row">
									      			...
									      			<div class="col-lg-12">
														<div class="table-responsive">
												      		<table class="table" id="tbl-update-capex">
																...
																<tbody>
																	<tr>
																		<td class=""><input type="hidden" class="asset-price update-capex-qty" name="price[]"><span class="asset-price"></span></td>
