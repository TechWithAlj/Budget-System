				...
				<div class="row">
					...
					<div class="col-lg-7">
						<div class="text-right">
							<a href="<?=base_url('business-center/download-capex/' . $year)?>" target="_blank"><span class="glyphicon glyphicon-download-alt"></span>&nbsp;&nbsp; Download CAPEX</a>
						</div>
					</div>
  				...
  				<div class="tab-content">
    				...
    				<div id="capex-tab" class="tab-pane fade in active">
    					...
    					<div id="add-btn">
							...
							<a href="<?=base_url('business-center/transac-capex/' . $year)?>" class="btn btn-success btn-xs">+ Add Capex</a>
						...
						<table class="table table-hover" id="tbl-capex-info">
							...
							<tbody>
								...
								<tr>
									...
									<td></td>
									<td><a href="<?=base_url('business-center/view-capex/' . encode($row->ag_trans_id))?>" class="btn btn-success btn-xs">View</a>&nbsp;&nbsp;
							    ...
							    <div class="modal-content">
							    	<div class="modal-header">
							      	...
							      	<div class="modal-body">
							      		<form method="POST" action="<?=base_url('business-center/cancel-capex')?>" enctype="multipart/form-data" id="cancel-capex">
			...
			<script type="text/javascript">
				$(document).ready(function(){
					...
					function amount_per_group(){
						var id = $('#id').val();
						var url = base_url + 'business-center/capex-donut/' + id + '/' + year;
						$.ajax({
					    	url: url,
					    	method: 'GET',
					...
					function amount_per_month(){
						var id = $('#id').val();
						var url = base_url + 'business-center/capex-line/' + id + '/' + year;
						$.ajax({
					    	url: url,
					    	method: 'GET',
					    	success:function(response){
					...
					function amount_per_month_group(){
						var id = $('#id').val();
						var url = base_url + 'business-center/capex-bar/' + id + '/' + year;
