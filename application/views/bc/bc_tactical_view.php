			...
			<div class="col-lg-12" id="content">
				<div id="breadcrumb-div">
					<ul class="breadcrumb">
					    ...
					    <li><a href="<?=base_url('business-center/tactical-info/')?>">&nbsp;Info</a></li>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<a href="" class="btn btn-success btn-xs edit-tactical" data-id="<?=encode($row->sales_tactical_item_id)?>">View</a>&nbsp;&nbsp;<a href="" class="btn btn-danger btn-xs cancel-tactical" data-id="<?=encode($row->sales_tactical_item_id)?>">Cancel</a>
					...
					<div class="modal-dialog modal-sm">
					    <div class="modal-content">
					    	<div class="modal-header">
					      	...
					      	<div class="modal-body">
					      		<form method="POST" action="<?=base_url('business-center/cancel-tactical-item')?>" enctype="multipart/form-data" id="cancel-tactical-price">
