        ...
        <div id="percent-rent-maintenance-tab" class="tab-pane fade in active">
                ...
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="<?=base_url('business-center/cancel-percent-rent')?>" enctype="multipart/form-data" id="remove-percent-rent">
            ...
            <div id="modal-percent-rent" class="modal fade modal-confirm" role="dialog">
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        <form method="POST" class="comparative-form" action="<?=base_url('business-center/upload-percent-rent')?>" enctype="multipart/form-data">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    No template? 
                                    <a class="card-link" href="<?=base_url('business-center/download-percent-rent-temp/'.$bc_id)?>"><span class="fa fa-download"></span> Download here</a>
                                    <br>
                                    <hr>
                                    <label>Year:</label>
                                    <div class="form-group">
                ...
                <table class="table table-hover table-bordered table-stripe nowrap" id="tbl-percent-rent-maintenance">
                    ...
                    <?php foreach($percent_rent as $row):?>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><a href="<?=base_url('business-center/edit-percent-rent/' . encode($row->percent_rent_id).'/'.$bc_id)?>" class="btn btn-xs btn-success edit-broiler-group">Edit</a></td>
