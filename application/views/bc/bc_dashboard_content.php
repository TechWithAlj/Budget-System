    				...
    				<div id="executive-tab" class="tab-pane fade in active">
    					<div class="row">
    						<div class="col-lg-12 dashboard-row">
    							...
    							<div class="col-lg-4">
    								<div class="dashboard-label text-center">
    									<label><strong>Total Sales Unit</strong></label>
    							...
    							<div class="col-lg-4">
    								<div class="dashboard-label text-center">
    									<label><strong>Net Sales</strong></label>
    						...
    						<div class="col-lg-12 dashboard-row">
    							...
    							<div class="col-lg-6">
    								<div class="dashboard-label text-center">
    									<label><strong><?=$year?> % Sales Mix</strong></label>
    						...
    						<div class="col-lg-12 dashboard-row">
    							<div class="col-lg-6">
    								<div class="dashboard-label text-center">
    									<label><strong>NOI Comparative</strong></label>
    							...
    							<div class="col-lg-6">
    								<div class="dashboard-label text-center"><br /><br /><br />
	    								...
	    								<label class="chart-remarks"><strong>Open <span class="dashboard-num"><?=$outlet_new?></span> stores to end with <span class="dashboard-num"><?=$outlet_total?></span> stores in <span class="dashboard-num"><?=$year?></span></strong></label>
    								</div>
    							</div>
    						</div>
    						...
    						<div class="col-lg-12 dashboard-row">
    							<div class="col-lg-6">
    								<div class="dashboard-label text-center">
    									<label><strong>CAPEX</strong></label>
                            ...
                            <div class="col-lg-12">
                                <div class="dashboard-label">
                                    <table class="table table-bordered" id="price-assumption-tbl">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td rowspan="12" class="rowspan-center" style="vertical-align : middle;text-align:center;">COM</td>
                                            ...
                                            <!-- Van Sales -->
                                            <tr>
                                                <td rowspan="3" class="rowspan-center" style="vertical-align : middle;text-align:center;">VAN SALES</td>
                                                <td><?=$year - 2?> Actual</td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales_prev_year2_jan']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales_prev_year2_feb']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales_prev_year2_mar']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales_prev_year2_apr']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales_prev_year2_may']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales_prev_year2_jun']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales_prev_year2_jul']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales_prev_year2_aug']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales_prev_year2_sep']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales_prev_year2_oct']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales_prev_year2_nov']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales_prev_year2_dec']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales_prev_year2_avg']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales_prev_year2_min']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales_prev_year2_max']))?></td>
                                            </tr>

                                            <tr>
                                                <td><?=$year - 1?> YEE</td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales_prev_year1_jan']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales_prev_year1_feb']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales_prev_year1_mar']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales_prev_year1_apr']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales_prev_year1_may']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales_prev_year1_jun']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales_prev_year1_jul']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales_prev_year1_aug']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales_prev_year1_sep']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales_prev_year1_oct']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales_prev_year1_nov']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales_prev_year1_dec']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales_prev_year1_avg']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales_prev_year1_min']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales_prev_year1_max']))?></td>
                                            </tr>

                                            <tr>
                                                <td><?=$year?> Budget</td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales1']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales2']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales3']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales4']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales5']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales6']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales7']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales8']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales9']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales10']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales11']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales12']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales_avg']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales_min']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['vansales_max']))?></td>
                                            </tr>
                                            ...
                                            <!-- UR Special -->
                                            <tr>
                                                <td rowspan="42" class="rowspan-center" style="vertical-align : middle;text-align:center;">UR</td>
                                                <td rowspan="3" class="rowspan-center" style="vertical-align : middle;text-align:center;">UR SPECIAL</td>
                                                <td><?=$year - 2?> Actual</td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special_prev_year2_jan']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special_prev_year2_feb']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special_prev_year2_mar']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special_prev_year2_apr']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special_prev_year2_may']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special_prev_year2_jun']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special_prev_year2_jul']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special_prev_year2_aug']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special_prev_year2_sep']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special_prev_year2_oct']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special_prev_year2_nov']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special_prev_year2_dec']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special_prev_year2_avg']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special_prev_year2_min']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special_prev_year2_max']))?></td>
                                            </tr>

                                            <tr>
                                                <td><?=$year - 1?> YEE</td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special_prev_year1_jan']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special_prev_year1_feb']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special_prev_year1_mar']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special_prev_year1_apr']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special_prev_year1_may']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special_prev_year1_jun']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special_prev_year1_jul']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special_prev_year1_aug']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special_prev_year1_sep']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special_prev_year1_oct']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special_prev_year1_nov']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special_prev_year1_dec']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special_prev_year1_avg']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special_prev_year1_min']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special_prev_year1_max']))?></td>
                                            </tr>

                                            <tr>
                                                <td><?=$year?> Budget</td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special1']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special2']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special3']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special4']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special5']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special6']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special7']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special8']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special9']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special10']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special11']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special12']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special_avg']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special_min']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_special_max']))?></td>
                                            </tr>

                                            <!-- UR Fiesta -->
                                            <tr>
                                                <td rowspan="3" class="rowspan-center" style="vertical-align : middle;text-align:center;">UR FIESTA</td>
                                                <td><?=$year - 2?> Actual</td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta_prev_year2_jan']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta_prev_year2_feb']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta_prev_year2_mar']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta_prev_year2_apr']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta_prev_year2_may']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta_prev_year2_jun']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta_prev_year2_jul']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta_prev_year2_aug']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta_prev_year2_sep']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta_prev_year2_oct']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta_prev_year2_nov']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta_prev_year2_dec']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta_prev_year2_avg']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta_prev_year2_min']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta_prev_year2_max']))?></td>
                                            </tr>

                                            <tr>
                                                <td><?=$year - 1?> YEE</td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta_prev_year1_jan']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta_prev_year1_feb']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta_prev_year1_mar']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta_prev_year1_apr']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta_prev_year1_may']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta_prev_year1_jun']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta_prev_year1_jul']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta_prev_year1_aug']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta_prev_year1_sep']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta_prev_year1_oct']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta_prev_year1_nov']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta_prev_year1_dec']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta_prev_year1_avg']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta_prev_year1_min']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta_prev_year1_max']))?></td>
                                            </tr>

                                            <tr>
                                                <td><?=$year?> Budget</td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta1']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta2']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta3']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta4']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta5']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta6']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta7']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta8']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta9']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta10']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta11']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta12']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta_avg']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta_min']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_fiesta_max']))?></td>
                                            </tr>

                                            <!-- UR Reyal -->
                                            <tr>
                                                <td rowspan="3" class="rowspan-center" style="vertical-align : middle;text-align:center;">UR Reyal</td>
                                                <td><?=$year - 2?> Actual</td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal_prev_year2_jan']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal_prev_year2_feb']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal_prev_year2_mar']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal_prev_year2_apr']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal_prev_year2_may']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal_prev_year2_jun']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal_prev_year2_jul']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal_prev_year2_aug']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal_prev_year2_sep']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal_prev_year2_oct']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal_prev_year2_nov']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal_prev_year2_dec']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal_prev_year2_avg']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal_prev_year2_min']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal_prev_year2_max']))?></td>
                                            </tr>

                                            <tr>
                                                <td><?=$year - 1?> YEE</td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal_prev_year1_jan']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal_prev_year1_feb']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal_prev_year1_mar']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal_prev_year1_apr']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal_prev_year1_may']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal_prev_year1_jun']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal_prev_year1_jul']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal_prev_year1_aug']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal_prev_year1_sep']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal_prev_year1_oct']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal_prev_year1_nov']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal_prev_year1_dec']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal_prev_year1_avg']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal_prev_year1_min']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal_prev_year1_max']))?></td>
                                            </tr>

                                            <tr>
                                                <td><?=$year?> Budget</td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal1']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal2']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal3']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal4']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal5']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal6']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal7']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal8']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal9']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal10']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal11']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal12']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal_avg']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal_min']))?></td>
                                                <td class="text-right"><?=check_zero(number_format($price['ur_reyal_max']))?></td>
                                            </tr>
			...
			<script type="text/javascript">
	    		...
	    		$.ajax({
			    	url:  base_url + 'business-center/sales-mix/<?=$year?>',
			    	method: 'GET',
			    	success:function(response){
			    		...
			    		if(parse_response['result'] == 1){
			    			...
			    			for(var b in parse_response['info']){
                                ...
                                total1.push(parseFloat(parse_response['info'][b].total_sales_mix1));
                                total2.push(parseFloat(parse_response['info'][b].total_sales_mix2));
			    			...
			    			for(var c = 0; c < length; c++){
			    				...
			    				sales_mix_tbl +='<td>' + number_format(total1[c])  + '%</td>';
                                sales_mix_tbl +='<td>' + number_format(total2[c])  + '%</td>';
			    				sales_mix_tbl +='</tr>';
			    			}
