			...
			<div class="col-lg-12" id="content">
				<div id="breadcrumb-div">
					<ul class="breadcrumb">
					    ...
					    <li><a href="<?=base_url('business-center/view-prod-trans/' . $prod_trans_id.'/'.$bc_id.'/'.$process_type_id.'/'.$year)?>">Sales BOM Transaction Details </a></li>
					    <li class="active">Edit Sales BOM Transaction (<?=$bc->bc_name?>)</li>
					    <?php } else { ?>
					    <li><a href="<?=base_url('business-center/view-prod-trans/' . $prod_trans_id.'/'.$bc_id.'/'.$process_type_id.'/'.$year)?>">Production Transaction Details </a></li>
				...
				<form method="post" action="<?=base_url('business-center/update-prod-trans')?>" id="">
