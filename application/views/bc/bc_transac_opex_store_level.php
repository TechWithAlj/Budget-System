			...
			<div class="col-lg-12" id="content">
				<div id="breadcrumb-div">
					<ul class="breadcrumb">
					    ...
					    <li><a href="<?=base_url('business-center/opex-info/')?>">Info</a></li>
				...
				<form method="POST" id="add-opex-form">
					...
					<div class="row">
						<div class="col-lg-3">
                            ...
                            <label class="data-info">GL Class:</label>
							<select name="gl_class" id="opex-gl-class" class="form-control">
								<option value="">Select...</option>
								
								<?php if($sw == FALSE):?>

									<!-- <option value="<?=encode(1)?>">SALARIES & WAGES</option> -->

								<?php endif;?>

								<?php foreach($gl_class as $row_gl):?>

									<option value="<?=encode($row_gl->gl_class_id)?>"><?=$row_gl->gl_class_name?></option>

								<?php endforeach;?>
                            </select>
						</div>

						<div id="store-brand" class="col-lg-3 hide-info">
							<label class="data-info">Brand:</label>
							<select name="opex_brand" id="opex-brand" class="form-control">
								<option value="">Select...</option>
						...
						<div id="store-outlet" class="col-lg-3 hide-info">
						...
						<div id="store-templates" class="col-lg-3 hide-info">
							<br/ ><br/ >

							<a href="" id="templates-store" class="btn btn-info btn-sm" target="_blank"><span class="fa fa-download"></span>&nbsp;&nbsp;Templates</a>&nbsp;&nbsp;<a href="#" id="templates-store" class="btn btn-success btn-sm" data-toggle="modal" data-target="#modal-store-expense" target="_blank"><span class="fa fa-download"></span>&nbsp;&nbsp;Upload</a>
						</div>
					</div>
					...
					<div class="modal-dialog modal-sm">
					    <div class="modal-content">
					    	<div class="modal-header">
					      	...
					      	<div class="modal-body">
					        	<form method="POST" action="<?=base_url('business-center/upload-store-expense')?>" enctype="multipart/form-data" id="upload-store-expense">
