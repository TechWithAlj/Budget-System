			...
			<div class="col-lg-12" id="content">
				<div id="breadcrumb-div">
					<ul class="breadcrumb">
					    ...
					    <li><a href="<?=base_url('business-center/capex-info/')?>">CAPEX Info</a></li>
					    <li><a href="<?=base_url('business-center/view-capex/' . $id)?>">View</a></li>
				...
				?>
				<form method="POST" action="<?=base_url('business-center/add-trans-capex-item')?>" id="add-trans-capex-item">
