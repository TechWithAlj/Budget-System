				...
				<div class="col-lg-7">
					<div id="order">
						...
						<div id="order-content">
							<form method="POST" action="<?=base_url('business-center/add-purchase')?>" id="add-purchase" class="form-inline">
								<div id="order-info">
										...
										<div class="form-group">
											<div class="date">
			                                    <div class="input-group input-append date" id="month">
			                                        <input type="text" name="month" class="form-control input-sm" id="date-pick-month" placeholder="Pick month" value="">
