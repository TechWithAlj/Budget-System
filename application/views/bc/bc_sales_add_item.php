			...
			<div class="col-lg-12" id="content">
				<div id="breadcrumb-div">
					<ul class="breadcrumb">
					    ...
					    <li><a href="<?=base_url('business-center/sales-view/' . $id)?>">View</a></li>
				...
				<div class="row">
					...
					<div class="col-lg-3">
						<label id="data-info">Brand: <span class="sales-total"><?=$brand_name?></span></label>
					</div>
				</div>
				...
				<form action="<?=base_url('business-center/add-trans-sales-item')?>" method="POST" enctype="multipart/form-data" id="add-sales-item">
					<div class="row">
