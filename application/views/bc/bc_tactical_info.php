						...
						<?php if($budget_status == 1):?>
									    ...
									    <div class="modal-content">
									    	<div class="modal-header">
									      	...
									      	<div class="modal-body">
									        	<form method="POST" action="<?=base_url('business-center/add-tactical-price')?>" enctype="multipart/form-data" id="add-tactical-price">
							...
							<div class="col-lg-8">
								<div class="text-right">
									<a href="<?=base_url('business-center/download-tactical/' . $year)?>" target="_blank"><span class="glyphicon glyphicon-download-alt"></span>&nbsp;&nbsp; Download Tactical</a>
								</div>
							</div>
				...
				<table class="table table-hover" id="tbl-employee">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="<?=base_url('business-center/tactical-view/' . encode($row->sales_tactical_id))?>" class="btn btn-success btn-xs" data-id="<?=encode($row->sales_tactical_id)?>">View</a>&nbsp;&nbsp;

								<?php if($budget_status == 1):?>

								<a href="" class="btn btn-danger btn-xs cancel-tactical" data-id="<?=encode($row->sales_tactical_id)?>">Cancel</a>
					...
					<div class="modal-dialog" style="width:1250px;">
					    <div class="modal-content">
					    	<div class="modal-header">
					      	...
					      	<div class="modal-body">
					        	<form method="POST" action="<?=base_url('business-center/update-tactical-price')?>" enctype="multipart/form-data" id="update-tactical-price">
					...
					<div class="modal-dialog modal-sm">
					    <div class="modal-content">
					    	<div class="modal-header">
					      	...
					      	<div class="modal-body">
					      		<form method="POST" action="<?=base_url('business-center/cancel-tactical-price')?>" enctype="multipart/form-data" id="cancel-tactical-price">
