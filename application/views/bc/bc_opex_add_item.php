			...
			<div class="col-lg-12" id="content">
				<div id="breadcrumb-div">
					<ul class="breadcrumb">
					    ...
					    <li><a href="<?=base_url('business-center/opex-info/' . $cost_center_code)?>">OPEX Info</a></li>
					    <li><a href="<?=base_url('business-center/view-opex/' . $id)?>">View</a></li>
				...
				<div class="row">
					<div class="col-lg-12">
						<form method="POST" action="<?=base_url('business-center/add-trans-opex-item')?>" id="add-trans-opex-item">
							<input type="hidden" id="id" name="gl_trans_id" value="<?=$id?>">
