				...
				<div id="add-btn">
					<div class="row">
						...
						<?php if($budget_status == 1):?>
									    ...
									    <div class="modal-content">
									    	<div class="modal-header">
									      	...
									      	<div class="modal-body">
									        	<form method="POST" action="<?=base_url('business-center/add-employee')?>" enctype="multipart/form-data" id="add-employee">
									...
									<div class="modal-dialog modal-sm">
									    <div class="modal-content">
									    	<div class="modal-header">
									      	...
									      	<div class="modal-body">
									        	<form method="POST" action="<?=base_url('business-center/upload-employees')?>" enctype="multipart/form-data" id="upload-employees">
									        		<input type="hidden" name="year" value="<?=$year?>">
									        		<div class="form-group">
							...
							<div class="col-lg-7">
								<div class="text-right">
									<a href="<?=base_url('business-center/download-employees/' . $year)?>" target="_blank"><span class="glyphicon glyphicon-download-alt"></span>&nbsp;&nbsp; Download Employees</a>
								</div>
							</div>
				...
				<table class="table table-hover" id="tbl-employee">
					...
					<tbody>
						...
						<tr>
							...
							<td><?=$row->emp_lname?></td>
							<td><?=$row->emp_no?></td>
							<td class="text-right"><?=number_format($row->emp_year_salary)?></td>
					...
					<div class="modal-dialog modal-sm">
					    <div class="modal-content">
					    	<div class="modal-header">
					      	...
					      	<div class="modal-body">
					        	<form method="POST" action="<?=base_url('business-center/update-employee')?>" enctype="multipart/form-data" id="update-employee">
					...
					<div class="modal-dialog modal-sm">
					    <div class="modal-content">
					    	<div class="modal-header">
					      	...
					      	<div class="modal-body">
					        	<form method="POST" action="<?=base_url('business-center/deactivate-employee')?>" enctype="multipart/form-data">
					...
					<div class="modal-dialog modal-sm">
					    <div class="modal-content">
					    	<div class="modal-header">
					      	...
					      	<div class="modal-body">
					        	<form method="POST" action="<?=base_url('business-center/activate-employee')?>" enctype="multipart/form-data">
					        		<input type="hidden" name="id" value="" id="id">
