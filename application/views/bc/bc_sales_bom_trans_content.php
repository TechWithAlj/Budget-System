			<div class="col-lg-12" id="content">
					    ...
					    <div class="modal-content">
					    	<div class="modal-header">
					      	...
					      	<div class="modal-body">
					      		<form method="POST" action="<?=base_url('business-center/cancel-sales-bom-trans')?>" enctype="multipart/form-data" id="remove-prod-trans">
				...
				<div id="add-btn">
					...
					<a href="<?=base_url('business-center/new-sales-bom-trans/' .$bc_id. '/'. $year)?>" class="btn btn-success btn-xs" id="add_sales_bom_trans_button">+ Add Sales BOM Transaction</a>
					...
					<a href="<?=base_url('business-center/view-sales-bom-summary/' .$bc_id.'/'.$year)?>" class="btn btn-info btn-xs" id="view_sales_bom_summary_button"> View Sales BOM Summary</a>
					
					<a href="<?=base_url('business-center/create-by-product-on-sales-bom/' .$bc_id.'/'.$year)?>" class="btn btn-primary btn-xs" id="create_by_product_on_sales_bom"> Sync By Products</a>
				</div>
