			...
			<div class="col-lg-12" id="content">
				<div id="breadcrumb-div">
					<ul class="breadcrumb">
					    ...
					    <li><a href="<?=base_url('business-center/broiler-trans/' . $bc_id.'/'.decode($trans_year))?>">Broiler Transaction</a></li>
				...
				<div id="add-btn">
					<a href="<?=base_url('business-center/view-broiler-summary/' . $bc_id .'/'. $trans_year)?>" class="btn btn-info btn-xs">VIEW BROILER COST SUMMARY</a>
