			<div class="col-lg-12" id="content">
				<div id="breadcrumb-div">
					<ul class="breadcrumb">
					    ...
					    <li><a href="<?=base_url('business-center/broiler-trans/'.$bc_id.'/'.$pick_year)?>">Broiler Transaction Info</a></li>
					    <li class="active">Add Industry Data (<?=$bc->bc_name?>)</li>
					</ul>
				</div>
				...
				<form method="post" action="<?=base_url('business-center/add-industry-trans')?>" id="">
					...
					<div class="table-responsive">
						<table class="table table-hover nowrap" id="tbl-new-industry-trans" width="100%">
							...
							<tbody>
								<?php foreach($industry_data as $row): ?>
								<tr>
									<td><a href="#" class="remove-asg"><i class="fa fa-remove"></i></a></td>
									<input type="hidden" name="industry_id[]" value="<?=encode($row->industry_id)?>">
									<td><?=$row->industry_name?></td>
									<td class="text-center">
										<input type="text" size="100" name="beginning[]">
									</td>
									<td class="text-center">
										<input type="text" size="100" name="current[]">
									</td>
									<td class="text-center">
										<input type="text" size="100" name="ending[]">
									</td>
								</tr>
								<?php endforeach; ?>
							</tbody>
