			...
			<div class="col-lg-12" id="content">
				<div id="breadcrumb-div">
					<ul class="breadcrumb">
					    ...
					    <li><a href="<?=base_url('business-center/view-store-expense/' . $gl_trans_id.'/NULL/NULL/'.$direct_labor)?>">View <?=$add_button?></a></li>
					    <li class="active">Store Expense Item</li>
					</ul>
				</div>
				...
				<div id="add-btn">
					<?php if($budget_status == TRUE):?>
						
						<a href="<?=base_url('business-center/add-store-expense-item/' . $id . '/' . $year .'/'. $direct_labor)?>" class="btn btn-success btn-xs">+ Add <?=$add_button?></a>
									...
									?>
										...
										<tr>
											<td>
												...
												<a href="" class="remove-opex-item remove" data-direct-labor="<?=$direct_labor?>" data-id="<?=encode($row->gl_trans_item_id)?>"><span class="fa fa-remove"></span></a>&nbsp;&nbsp;&nbsp;<a href="" class="update update-store-expense-btn" data-direct-labor="<?=$direct_labor?>" data-id="<?=encode($row->gl_trans_item_id)?>"><span class="fa fa-pencil"></span></a>
								    ...
								    <div class="modal-content">
								    	<div class="modal-header">
								        	<button type="button" class="close" data-dismiss="modal">&times;</button>
								       		<strong>Remove Item <?=$add_button?></strong>
								      	</div>
								      	<form method="POST" action="<?=base_url('business-center/remove-store-expense-item')?>" id="remove-opex-item">
								      		<input type="hidden" id="id" name="id">
											<input type="hidden" id="direct-labor" name="direct-labor">
							...
							<div id="modal-update-opex-item" class="modal fade modal-confirm" role="dialog">
								<div class="modal-dialog" style="width:1250px;">
								    <div class="modal-content">
								    	<div class="modal-header">
								        	<button type="button" class="close" data-dismiss="modal">&times;</button>
								       		<strong>Update <?=$add_button?></strong>
								      	</div>
								      	<form method="POST" action="<?=base_url('business-center/update-store-expense-item')?>" id="update-store-expense-item">
								      		<input type="hidden" id="id" name="id[]">
