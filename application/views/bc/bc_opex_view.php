			...
			<div class="col-lg-12" id="content">
				...
				<div id="add-btn">
					...
					<a href="<?=base_url('business-center/add-opex-item/' . $id)?>" class="btn btn-success btn-xs">+ Add Opex Item</a>
								...
								<div class="modal-dialog modal-sm">
								    <div class="modal-content">
								    	<div class="modal-header">
								      	...
								      	<form method="POST" action="<?=base_url('business-center/remove-opex-item')?>" id="remove-opex-item">
								...
								<div class="modal-dialog" style="width:1250px;">
								    <div class="modal-content">
								    	<div class="modal-header">
								      	...
								      	<form method="POST" action="<?=base_url('business-center/update-opex-item')?>" id="update-opex-item">
								      		<input type="hidden" id="id" name="id[]">
									      	<div class="modal-body">
									      		<div class="row">
