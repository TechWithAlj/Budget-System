			...
			<div class="col-lg-12" id="content">
				...
				<div class="row">
					<div class="col-lg-3">
						<label class="data-info">Business Center: <?=$cost_center_desc?></label><br /><br />
					</div>
					...
					<div class="col-lg-7">
						<div class="text-right">
							<a href="<?=base_url('business-center/download-opex/' . $year)?>" target="_blank"><span class="glyphicon glyphicon-download-alt"></span>&nbsp;&nbsp; Download OPEX</a>
						</div>
					</div>
				</div>
				...
				<ul class="nav nav-tabs">
					...
					<!-- <li><a data-toggle="tab" class="tab-letter" href="#direct-labor-tab">Direct Labor</a></li> -->
  				...
  				<div class="tab-content">
    				...
    				<div id="opex-tab" class="tab-pane fade in active"><br/ >
						<div id="add-btn">
							...
							<a href="<?=base_url('business-center/transac-opex/' . $year .'/'. encode('2'))?>" class="btn btn-success btn-xs">+ Add Opex Unit</a>
							<a href="<?=base_url('business-center/transac-opex/' . $year .'/'. encode('1'))?>" class="btn btn-success btn-xs">+ Add Opex Store</a>

							<?php endif;?>
						</div>
						<table class="table table-hover" id="tbl-opex-info">
							<thead>
								<tr>
									<th>GL Group</th>
							...
							<tbody>
								...
								<tr>
									...
									<td></td>
									<td>
										<!-- <a href="<?=$row->gl_group_name != 'STORE EXPENSES' ? base_url('business-center/view-opex/' . encode($row->gl_trans_id)) : base_url('business-center/view-store-expense/' . encode($row->gl_trans_id))?>" class="btn btn-success btn-xs">View</a>&nbsp;&nbsp; -->

										<a href="<?=base_url('business-center/view-opex/' . encode($row->gl_trans_id))?>" class="btn btn-success btn-xs">View Opex Unit</a>&nbsp;&nbsp;
										<a href="<?=base_url('business-center/view-store-expense/' . encode($row->gl_trans_id) . '/'. $id . '/' . $year )?>" class="btn btn-success btn-xs">View Opex Store</a>&nbsp;&nbsp;

										<?php if($budget_status == 1):?>

										<a data-id="<?=encode($row->gl_trans_id)?>" class="btn btn-danger btn-xs cancel-opex-btn">Cancel</a>
								...
								?>	
									<tr>
										...
										<td><?=$row_sw->emp_salary_trans_year?></td>
										<td></td>
										<td><a href="<?=base_url('business-center/sw-view/' . encode($row_sw->emp_salary_trans_id))?>" class="btn btn-success btn-xs">View</a>&nbsp;&nbsp;

											<?php if($budget_status == 1):?>

											<a data-id="<?=encode($row_sw->emp_salary_trans_id)?>" class="btn btn-danger btn-xs cancel-sw-btn">Cancel</a>
							    ...
							    <div class="modal-content">
							    	<div class="modal-header">
							      	...
							      	<div class="modal-body">
							      		<form method="POST" action="<?=base_url('business-center/cancel-opex')?>" enctype="multipart/form-data" id="cancel-opex">
					...
					<div id="modal-cancel-direct-labor" class="modal fade" role="dialog">
						<div class="modal-dialog modal-sm">
							<div class="modal-content">
								<div class="modal-header">
									<button type="button" class="close" data-dismiss="modal">&times;</button>
									<strong>Cancel Direct Labor</strong>
								</div>
								<div class="modal-body">
									<form method="POST" action="<?=base_url('business-center/cancel-opex')?>" enctype="multipart/form-data" id="cancel-direct-labor">
										<input type="hidden" name="id" id="id">
										<input type="hidden" name="direct-labor" value="<?=encode('1')?>">
										<div id="modal-msg" class="text-center">
											<label>Are you sure to cancel this direct labor?</label>
										</div>
										<div id="modal-btn" class="text-center">
											<button type="submit" class="btn btn-info btn-sm">Yes</button>&nbsp;&nbsp;
											<a href="" data-dismiss="modal" class="btn btn-danger btn-sm">No</a>
						...
						<div class="modal-dialog modal-sm">
						    <div class="modal-content">
						    	<div class="modal-header">
						      	...
						      	<div class="modal-body">
						      		<form method="POST" action="<?=base_url('business-center/cancel-sw-opex')?>" enctype="multipart/form-data" id="cancel-sw-opex">
						      			<input type="hidden" name="id" id="id">
							        	<div id="modal-msg" class="text-center">
							        		<label>Are you sure to cancel this OPEX?</label>
							        	</div>
					...
					<!-- <div id="direct-labor-tab" class="tab-pane fade in active"><br/ >
						<div id="add-btn">
							
							<a href="<?=base_url('business-center/transac-opex/' . $year .'/'. encode('1').'/0/0/'.encode('1'))?>" class="btn btn-success btn-xs">+ Add Direct Labor</a>
						</div>
						<table class="table table-hover" id="tbl-opex-info-direct-labor">
							<thead>
								<tr>
									<th>GL Group</th>
									<th>Cost Center Desc</th>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										<a href="<?=base_url('business-center/view-store-expense/' . encode($row->gl_trans_id) . '/'. $id . '/' . $year .'/'. encode('1') )?>" class="btn btn-success btn-xs">View Direct Labor</a>&nbsp;&nbsp;
										&nbsp;&nbsp;

										<?php if($budget_status == 1):?>

										<a data-id="<?=encode($row->gl_trans_id)?>" data-direct-labor="<?=encode('1')?>" class="btn btn-danger btn-xs cancel-direct-labor-btn">Cancel</a>
							...
							<div class="modal-dialog modal-sm">
							    <div class="modal-content">
							    	<div class="modal-header">
							      	...
							      	<div class="modal-body">
							      		<form method="POST" action="<?=base_url('admin/cancel-opex')?>" enctype="multipart/form-data" id="cancel-opex">
							      			<input type="hidden" name="id" id="id">
								        	<div id="modal-msg" class="text-center">
								        		<label>Are you sure to cancel this OPEX?</label>
								        	</div>
							...
							<div class="modal-dialog modal-sm">
							    <div class="modal-content">
							    	<div class="modal-header">
							      	...
							      	<div class="modal-body">
							      		<form method="POST" action="<?=base_url('admin/cancel-sw-opex')?>" enctype="multipart/form-data" id="cancel-sw-opex">
							      			<input type="hidden" name="id" id="id">
								        	<div id="modal-msg" class="text-center">
								        		<label>Are you sure to cancel this OPEX?</label>
								        	</div>
					...
					<div id="opex-graph-tab" class="tab-pane fade">
						...
						<div class="row">
											...
											foreach($opex_gl as $row_opex):
												...
												if($gl_name != $row_opex->gl_group_name){
													...
													if($count > 0){
														...
														echo '<td class="text-right">' . number_format($gl_total_dif2) . '</td>';
							...
							<div id="opex-table" class="col-lg-offset-1 col-lg-10">
								<table class="table" id="tbl-opex-monthly">
									<thead>
										<tr>
											<td colspan="13" class="text-center"><strong>Monthly OPEX <?=$year?></strong></td>
										</tr>
										<tr>
											<td>GL GROUP</td>
			...
			<script type="text/javascript">
				$(document).ready(function(){
					...
					function amount_per_gl(){
						var url = base_url + 'business-center/opex-donut/' + id + '/' + year;
						$.ajax({
					    	url: url,
					    	method: 'GET',
					...
					function amount_per_month(){
						var url = base_url + 'business-center/opex-line/' + id + '/' + year;
						$.ajax({
					    	url: url,
					    	method: 'GET',
					    	success:function(response){
					...
					function amount_per_month_group(){
						var id = $('#id').val();
						var url = base_url + 'business-center/opex-bar/' + id + '/' + year;
					    		...
					    		if(parse_data['result'] == 1){
					    			...
					    			for(var a in parse_data['group_amount']){
					    				...
					    				for(var b =0; b < 12; b++){
					    					...
					    					month_total[b] += parseFloat(gl_amount);
					    				}
