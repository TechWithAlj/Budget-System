			...
			<div class="col-lg-12" id="content">
				<div id="breadcrumb-div">
					<ul class="breadcrumb">
					    ...
					    <li><a href="<?=base_url('business-center/opex')?>">OPEX</a></li>
					    <li><a href="<?=base_url('business-center/opex-info/' . $cost_center_code)?>">Info</a></li>
				...
				<div id="add-btn">
					...
					<a href="<?=base_url('business-center/add-sw-item/' . $id)?>" class="btn btn-success btn-xs">+ Add S&W</a>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="table-responsive">
									...
									?>
										...
										<tr>
											<td>
												...
												<a href="" class="remove-sw-item remove" data-id="<?=encode($row->emp_salary_item_id)?>"><span class="fa fa-remove"></span></a>&nbsp;&nbsp;&nbsp;<a href="" class="update update-sw-item" data-id="<?=encode($row->emp_salary_item_id)?>"><span class="fa fa-pencil"></span></a>
							...
							<div id="modal-remove-sw-item" class="modal fade modal-confirm" role="dialog">
								<div class="modal-dialog modal-sm">
								    <div class="modal-content">
								    	<div class="modal-header">
								      	...
								      	<form method="POST" action="<?=base_url('business-center/remove-sw-item')?>" id="remove-sw-item">
								...
								<div class="modal-dialog" style="width:1250px;">
								    <div class="modal-content">
								    	<div class="modal-header">
								      	...
								      	<form method="POST" action="<?=base_url('business-center/update-sw-item')?>" id="update-sw-item">
								      		<input type="hidden" id="id" name="id[]">
									      	<div class="modal-body">
									      		<div class="row">
										      		<label id="label-gl" class="col-lg-3 data-info">GL Group: <span class="val"></span></label>
										      		
										      		<label id="label-total-amount" class="col-lg-3 data-info">Total Amount: <span class="val"></span></label>
										      		

										      		<label class="col-lg-3 data-info">Employee: <span class="val label-emp"></span></label>
										      		<br /><br /><br /><br />
