			...
			<div class="col-lg-12" id="content">
				<div id="breadcrumb-div">
					<ul class="breadcrumb">
					    <li><a href="<?=base_url('business-center/dashboard')?>"><span class="glyphicon glyphicon-home"></span>&nbsp;Dashboard</a></li>
				...
				<div class="row">
					...
					<div class="col-lg-9">
						<div class="text-right">
							<a href="<?=base_url('business-center/download-gl/')?>" target="_blank"><span class="glyphicon glyphicon-download-alt"></span>&nbsp;&nbsp; Download GL</a>
						</div>
					</div>
				</div>
