			<div class="col-lg-12" id="content">
				<div id="breadcrumb-div">
					<ul class="breadcrumb">
					    ...
					    <li><a href="<?=base_url('business-center/production-cost')?>">Production Cost</a></li>
				...
				<div class="tab-content">
					<div id="internal-prod-trans-tab" class="tab-pane fade in active">
							    ...
							    <div class="modal-content">
							    	<div class="modal-header">
							      	...
							      	<div class="modal-body">
							      		<form method="POST" action="<?=base_url('business-center/cancel-prod-trans')?>" enctype="multipart/form-data" id="remove-prod-trans">
							...
							<div class="modal-dialog modal-sm">
							    <div class="modal-content">
							    	<div class="modal-header">
							      	...
							      	<form method="POST" action="<?=base_url('business-center/copy-prod-trans')?>" enctype="multipart/form-data" id="remove-prod-trans">
								      	<div class="modal-body">
						...
						<div id="add-btn">
							...
							<input type="hidden" id="lock_status_2" value="<?=$pending_lock_status_2;?>">

							<a href="<?=base_url('business-center/new-prod-trans/' .$bc_id.'/'.$year)?>" class="btn btn-success btn-xs" id="add_prod_trans_button">+ Add Production Transaction</a>
							...
							<a href="<?=base_url('business-center/view-cost-sheet-report/' .$bc_id.'/'.$year)?>" class="btn btn-info btn-xs" id=""> View All Processed Cost Sheet</a>
						</div>
							...
							<table class="table table-hover table-bordered table-stripe nowrap" id="tbl-prod-trans">
								...
								?>
									...
									<tr>
										...
										<td class="text-center"><a href="<?=base_url('business-center/view-prod-trans/' . encode($row->prod_trans_id).'/'.$bc_id.'/'.encode($row->process_type_id).'/'.encode($year).'')?>" class="btn btn-xs btn-success edit-broiler-group">View</a></td>
					...
					<div id="external-prod-trans-tab" class="tab-pane fade in">
						...
						<div id="add-btn">
							<a href="#" data-toggle="modal" data-target="#modal-production-group" class="btn btn-success btn-xs" data-toggle="modal" data-target="#modal-vmaterial" id="add_ext_material">+ Add Material</a>&nbsp;&nbsp;<a href="<?=base_url('business-center/new-ext-prod-trans/' .$bc_id .'/'. $year)?>" class="btn btn-success btn-xs" id="add_ext_transaction">+ Add Transaction</a>
							&nbsp;<a href="<?=base_url('business-center/view-ext-prod-trans/' .$bc_id .'/'. $year)?>" class="btn btn-primary btn-xs" id="view_ext_transaction">View All Transaction</a>
							...
							<div class="modal-dialog modal-sm">
							    <div class="modal-content">
							    	<div class="modal-header">
							      	...
							      	<div class="modal-body">
							        	<form method="POST" action="<?=base_url('business-center/add-ext-prod')?>" enctype="multipart/form-data" id="add-material">
							        		<input type="hidden" name="bc_id" id="bc_id" value="<?=$bc_id?>">
							        		<div class="form-group">
							...
							<div class="modal-dialog modal-sm">
							    <div class="modal-content">
							    	<div class="modal-header">
							      	...
							      	<div class="modal-body">
							      		<form method="POST" action="<?=base_url('business-center/cancel-ext-prod-trans')?>" enctype="multipart/form-data" id="remove-ext-prod-trans">
						...
						<div id="modal-upload-ext-prod" class="modal fade modal-confirm" role="dialog">
							<div class="modal-dialog modal-md">
							    <div class="modal-content">
							        <form method="POST" class="comparative-form" action="<?=base_url('business-center/upload-ext-prod')?>" enctype="multipart/form-data">
								    	<div class="modal-header">
								        	<button type="button" class="close" data-dismiss="modal">&times;</button>
								      	...
								      	<div class="modal-body">
			                                ...
			                                <div class="form-group">
			                                	No template? 
			                                	<a class="card-link" href="<?=base_url('business-center/download-ext-prod-temp')?>"><span class="fa fa-download"></span> Download here</a>
			                                	<br>
			                                	<hr>
							...
							<div class="modal-dialog modal-sm">
							    <div class="modal-content">
							    	<div class="modal-header">
							      	...
							      	<div class="modal-body">
							        	<form method="POST" action="<?=base_url('business-center/batch-cancel-ext-prod-trans')?>" enctype="multipart/form-data" id="form-ext-cancellation">
							        		<div class="form-group">
							        		...
							        		<div class="form-group">
							        			...
							        			<select class="form-control" name="ext_prod_trans_id[]" id="ext_prod_trans_id">
							        				<option value="">Select...</option>
							...
							<table class="table table-hover table-bordered table-stripe nowrap" id="tbl-prod-trans-external">
								...
								?>
									<tr>
										...
										<td><?=$row->user_fname.' '.$row->user_lname?></td>
										<td><?=date( 'm/d/Y', strtotime($row->created_ts))?></td>
										<td class="text-center"><a href="<?=base_url('business-center/edit-ext-prod-trans/' . encode($row->ext_prod_trans_id).'/'.$bc_id .'/'. $year)?>" class="fa fa-pencil"></a>&nbsp;&nbsp;<a href="#" data-id="<?=encode($row->ext_prod_trans_id)?>" data-bc_id="<?=$bc_id?>" class="remove-ext-prod-trans fa fa-remove"></a></td>
									</tr>
