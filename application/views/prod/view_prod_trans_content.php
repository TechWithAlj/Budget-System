			...
			<div class="col-lg-12" id="content">
				<div id="breadcrumb-div">
					<ul class="breadcrumb">
					    ...
					    <li><a href="<?=base_url('production/sales-bom-trans/'.$bc_id)?>">Sales BOM Transaction</a></li>
						...
						<tbody>
							...
							foreach($prod_trans as $row){
								...
								if($row->prod_trans_dtl_status == 1){
									$prod_trans_output .= "<td class='text-center'><a href='".base_url('production/edit-prod-trans/' . encode($row->prod_trans_id).'/'.encode($row->config_prod_dtl_id).'/'.$bc_id.'/'.encode($year).'/'.$process_type_id)."'><i class='fa fa-pencil'></i></a></td>";
								} else {
