...
<head>
	...
	<script type="text/javascript" src="<?=base_url()?>assets/js/chartjs-plugin-labels.min.js"></script>
	<script src="<?=base_url()?>assets/js/prod.js?v=2.5"></script>
</head>
<body>
			...
			<div class="row">
				...
				<div id="nav">
					<ul>
						...
						<li class="<?=$this->uri->segment(2) == 'dashboard' ? 'active' : ''?>" style="margin:auto; text-align: center"><a href="<?=base_url('production/dashboard')?>"><img src="<?=base_url()?>assets/img/icon/dashboard.png" width="25px"><br>Dashboard</a></li>
						<!-- <li class="<?=$this->uri->segment(2) == 'broiler-cost' || $this->uri->segment(2) == 'add-broiler-config' ? 'active' : ''?>" style="margin:auto; text-align: center"><a href="<?=base_url('admin/broiler-cost')?>"><img height="25" width="25" src="<?=base_url()?>assets/img/icon/broiler.png" ><br>Broiler Cost</a></li> -->

						<li class="<?=$this->uri->segment(2) == 'production-cost' || $this->uri->segment(2) == 'add-broiler-config' || ($segment == 'view-config-prod' && decode($this->uri->segment(4)) != 5) || $segment == 'prod-trans' || ($segment == 'view-prod-trans' && decode($this->uri->segment(5)) != 5) || ($segment == 'view-cost-sheet' && decode($this->uri->segment(6)) != 5) || $segment == 'new-prod-trans' || ($segment == 'edit-prod-trans' && decode($this->uri->segment(7)) != 5) || $segment == 'new-ext-prod-trans' || $segment == 'edit-ext-prod-trans' ? 'active' : ''?>" style="margin:auto; text-align: center"><a href="<?=base_url('production/production-cost')?>"><img height="25" width="25" src="<?=base_url()?>assets/img/icon/production.png" ><br>Production Cost</a></li>


						<li class="<?=$this->uri->segment(2) == 'logout' ? 'active' : ''?>" style="margin:auto; text-align: center"><a href="<?=base_url('production/logout')?>"><img src="<?=base_url()?>assets/img/icon/logout.png" width="24px" height="24px"><br>Logout</a></li>
					</ul>
				</div>
			</div>
