							    ...
							    <div class="modal-content">
							    	<div class="modal-header">
							      	...
							      	<div class="modal-body">
							        	<form method="POST" action="<?=base_url('production/add-config-prod')?>" enctype="multipart/form-data" id="add-material">
						...
						<table class="table table-hover" id="tbl-broiler-group">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center"><a href="<?=base_url('production/view-config-prod/' . encode($row->config_prod_id).'/'.encode($row->process_type_id))?>" class="btn btn-xs btn-success edit-broiler-group" data-id="<?=encode($row->config_prod_id)?>">View</a></td>
									<!--&nbsp;&nbsp;<a href="<?=base_url('production/view-broiler-group/' . encode($row->broiler_group_id))?>" class="btn btn-danger btn-xs glyphicon glyphicon-remove cancel-broiler-group" data-id="<?=encode($row->broiler_group_id)?>"></a> -->
					...
					<div id="prod-config-tab" class="tab-pane fade in active">
						...
						<table class="table table-hover" id="tbl-broiler-config">
							...
							<tbody>
								...
								<tr>
									<td><?=$row->bc_name?></td>
									<td class="text-center"><a href="<?=base_url('production/prod-trans/' . encode($row->bc_id))?>" class="btn btn-success btn-xs">view</a></td>
								</tr>
								<?php endforeach;?>
