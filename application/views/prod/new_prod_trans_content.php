			...
			<div class="col-lg-12" id="content">
				<div id="breadcrumb-div">
					<ul class="breadcrumb">
					    ...
					    <li class="active">Add Production Transaction (<?=$bc->bc_name?>)</li>
					</ul>
				</div>
				...
				?>
				<form method="post" action="<?=base_url('production/add-prod-trans')?>" enctype="multipart/form-data" id="add-material">
