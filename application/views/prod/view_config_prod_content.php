			<div class="col-lg-12" id="content">
				<div id="breadcrumb-div">
					<ul class="breadcrumb">
					    ...
					    <li><a href="<?=base_url('production/sales-bom')?>">Sales BOM</a></li>
						    ...
						    <div class="modal-content">
						    	<div class="modal-header">
						      	...
						      	<div class="modal-body">
						        	<form method="POST" action="<?=base_url('production/add-config-prod-dtl')?>" enctype="multipart/form-data" id="add-material">
						...
						<div class="modal-dialog modal-sm">
						    <div class="modal-content">
						    	<div class="modal-header">
						      	...
						      	<div class="modal-body">
						      		<form method="POST" action="<?=base_url('production/remove-config-prod-dtl')?>" enctype="multipart/form-data" id="remove-config-prod-dtl">
