			...
			<div class="col-lg-12" id="content">
				<div id="breadcrumb-div">
					<ul class="breadcrumb">
					    ...
					    <li><a href="<?=base_url('production/view-prod-trans/' . $prod_trans_id.'/'.$bc_id.'/'.$process_type_id)?>">Sales BOM Transaction Details </a></li>
					    <li class="active">Edit Sales BOM Transaction (<?=$bc->bc_name?>)</li>
					    <?php } else { ?>
					    <li><a href="<?=base_url('production/view-prod-trans/' . $prod_trans_id.'/'.$bc_id.'/'.$process_type_id)?>">Production Transaction Details </a></li>
				...
				<form method="post" action="<?=base_url('production/update-prod-trans')?>" id="">
