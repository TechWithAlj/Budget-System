									    ...
									    <div class="modal-content">
									    	<div class="modal-header">
									      	...
									      	<div class="modal-body">
									        	<form method="POST" action="<?=base_url('unit/add-manpower')?>" enctype="multipart/form-data" id="add-manpower">
						...
						<div class="modal-dialog modal-sm">
						    <div class="modal-content">
						    	<div class="modal-header">
						      	...
						      	<div class="modal-body">
						      		<form method="POST" id="cancel-employee" action="<?=base_url('unit/cancel-manpower/')?>">
					...
					<div class="modal-dialog modal-sm">
					    <div class="modal-content">
					    	<div class="modal-header">
					      	...
					      	<div class="modal-body">
					        	<form method="POST" action="<?=base_url('unit/update-manpower')?>" enctype="multipart/form-data" id="update-manpower">
					        		<input type="hidden" name="id" id="id">
					...
					<div class="modal-dialog modal-sm">
					    <div class="modal-content">
					    	<div class="modal-header">
					      	...
					      	<div class="modal-body">
					        	<form method="POST" action="<?=base_url('unit/remove-manpower')?>" enctype="multipart/form-data">
