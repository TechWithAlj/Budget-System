			...
			<div class="col-lg-12" id="content">
				...
				<?php if($budget_status == 1):?>
					...
					<div id="add-btn">
						<a href="<?=base_url('unit/add-sw-item/' . $id)?>" class="btn btn-success btn-xs">+ Add S&W</a>
					</div>
								...
								<div class="modal-dialog modal-sm">
								    <div class="modal-content">
								    	<div class="modal-header">
								      	...
								      	<form method="POST" action="<?=base_url('unit/remove-sw-item')?>" id="remove-sw-item">
								...
								<div class="modal-dialog" style="width:1250px;">
								    <div class="modal-content">
								    	<div class="modal-header">
								      	...
								      	<form method="POST" action="<?=base_url('unit/update-sw-item')?>" id="update-sw-item">
								      		<input type="hidden" id="id" name="id[]">
									      	<div class="modal-body">
									      		<div class="row">
