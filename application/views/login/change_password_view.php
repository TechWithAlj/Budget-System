...
<head>
	...
	<title>BAVI Budget System</title>
				...
				<div class="col-lg-4 col-md-4" id="login-div">
					...
					<div id="login-form">
						<div class="text-center">
							<div class="alert alert-success">Change your password.</div>
						</div>
						<?php
						...
						?>
						<form action="<?=base_url()?>login/change-process" method="POST">
							...
							<div class="form-group text-right">
								<button type="submit" id="login-btn" class="btn btn-info btn-sm">Change Password</button>
							</div>
						</form>
					</div>
				</div>
