			...
			<div class="col-lg-12" id="content">
				<div id="breadcrumb-div">
					<ul class="breadcrumb">
					    ...
					    <li><a href="<?=base_url('admin/opex-info/' . $parent)?>">Info</a></li>
					    <li><a href="<?=base_url('admin/view-store-expense/' . $gl_trans_id.'/NULL/NULL/'.$direct_labor)?>">View <?=$add_button?></a></li>
					    <li class="active">Store <?=$add_button?></li>
					</ul>
				</div>
				...
				<div id="add-btn">
					<a href="<?=base_url('admin/add-store-expense-item/' . $id . '/' . $year .'/'. $direct_labor)?>" class="btn btn-success btn-xs">+Add <?=$add_button?></a>
				</div>
							...
							<table class="table table-bordered" id="tbl-view-capex">
								...
								<tbody>
									...
									?>
										...
										<tr>
											<td><a href="" class="remove-opex-item remove" data-direct-labor="<?=$direct_labor?>" data-id="<?=encode($row->gl_trans_item_id)?>"><span class="fa fa-remove"></span></a>
											&nbsp;&nbsp;&nbsp;<a href="" class="update update-store-expense-btn" data-direct-labor="<?=$direct_labor?>" data-id="<?=encode($row->gl_trans_item_id)?>"><span class="fa fa-pencil"></span></a></td>
								...
								<div class="modal-dialog modal-sm">
								    <div class="modal-content">
								    	<div class="modal-header">
								      	...
								      	<form method="POST" action="<?=base_url('admin/remove-store-expense-item')?>" id="remove-opex-item">
								...
								<div class="modal-dialog" style="width:1250px;">
								    <div class="modal-content">
								    	<div class="modal-header">
								      	...
								      	<form method="POST" action="<?=base_url('admin/update-store-expense-item')?>" id="update-store-expense-item">
								      		<input type="hidden" id="id" name="id[]">
