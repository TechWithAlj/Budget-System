			...
			<div class="col-lg-12" id="content">
				...
				<div id="add-btn">
					<a href="<?=base_url('admin/add-sw-item/' . $id)?>" class="btn btn-success btn-xs">+ Add S&W</a>
				</div>
							...
							<table class="table table-bordered" id="tbl-view-capex">
								...
								<tbody>
									...
									?>
										...
										<tr>
											<td><a href="" class="remove-sw-item remove" data-id="<?=encode($row->emp_salary_item_id)?>"><span class="fa fa-remove"></span></a>&nbsp;&nbsp;&nbsp;<a href="" class="update update-sw-item" data-id="<?=encode($row->emp_salary_item_id)?>"><span class="fa fa-pencil"></span></a></td>
								...
								<div class="modal-dialog modal-sm">
								    <div class="modal-content">
								    	<div class="modal-header">
								      	...
								      	<form method="POST" action="<?=base_url('admin/remove-sw-item')?>" id="remove-sw-item">
								...
								<div class="modal-dialog" style="width:1250px;">
								    <div class="modal-content">
								    	<div class="modal-header">
								      	...
								      	<form method="POST" action="<?=base_url('admin/update-sw-item')?>" id="update-sw-item">
								      		<input type="hidden" id="id" name="id[]">
									      	<div class="modal-body">
									      		<div class="row">
