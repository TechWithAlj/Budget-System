			<div class="col-lg-12" id="content">
				<div id="breadcrumb-div">
					<ul class="breadcrumb">
					    ...
					    <?php } else { ?>
					    <li><a href="<?=base_url('admin/commi-production-cost#prod-group-tab')?>">Commissary Prod Cost</a></li>
						    	...
						    	<div class="modal-header">
						      	...
						      	<div class="modal-body">
						        	<form method="POST" action="<?=base_url('admin/upload-config-prod-dtl')?>" enctype="multipart/form-data" id="upload-materials">
										...
										<div class="text-right">
						        			<a href="<?=base_url('admin/download-prod-config-guide')?>" target="_blank"><span class="glyphicon glyphicon-download-alt"></span>&nbsp;&nbsp;Download Config Details</a>
						        		</div><br /><br />
