				...
				<div class="row">
					...
					<div class="col-lg-7">
						<div class="text-right">
							<a href="<?=base_url('admin/download-capex/' . $cost_center . '/' . $year)?>" target="_blank"><span class="glyphicon glyphicon-download-alt"></span>&nbsp;&nbsp; Download CAPEX</a>
						</div>
					</div>
				...
				<ul class="nav nav-tabs">
  				...
  				<div class="tab-content">
    				...
    				<div id="capex-tab" class="tab-pane fade in active">
    					<br>
    					<div id="add-btn">
							<a href="<?=base_url('admin/transac-capex/' . $id . '/' . $year)?>" class="btn btn-success btn-xs">+ Add Capex</a>
						</div>
							    ...
							    <div class="modal-content">
							    	<div class="modal-header">
							      	...
							      	<div class="modal-body">
							      		<form method="POST" action="<?=base_url('admin/cancel-capex')?>" enctype="multipart/form-data" id="cancel-capex">
			...
			<script type="text/javascript">
				$(document).ready(function(){
					...
					function amount_per_group(){
						var id = $('#id').val();
						var url = base_url + 'admin/capex-donut/' + id + '/' + year;
						$.ajax({
					    	url: url,
					    	method: 'GET',
					...
					function amount_per_month(){
						var id = $('#id').val();
						var url = base_url + 'admin/capex-line/' + id + '/' + year;
						$.ajax({
					    	url: url,
					    	method: 'GET',
					    	success:function(response){
					...
					function amount_per_month_group(){
						var id = $('#id').val();
						var url = base_url + 'admin/capex-bar/' + id + '/' + year;
