<div class="col-lg-12" id="content">
    <div id="breadcrumb-div">
        <ul class="breadcrumb">
            ...
            <li><a href="<?=base_url('admin/sales-commission-maintenance/'.$bc_id)?>">Sales Commission Maintenance</a></li>
    ...
    <form method="post" action="<?=base_url('admin/update-sales-commission')?>" id="">

        <input type="hidden" name="bc_id" value="<?=$bc_id?>">

        <label for="">Brand: <?=$sales_commission[0]->brand_name?></label><br>
        <label for="">Last Modified: <?=time_stamp_display($sales_commission[0]->sales_commission_det_added)?></label>
