								    ...
								    <div class="modal-content">
								    	<div class="modal-header">
								      	...
								      	<div class="modal-body">
								        	<form method="POST" action="<?=base_url('admin/add-brand-bc')?>" enctype="multipart/form-data" id="add-employee">
				...
				<table class="table table-hover" id="tbl-brand-bc-info">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="<?=base_url('admin/brand-bc-material-info/' . encode($row->brand_bc_id))?>" class="btn btn-xs btn-success">Material</a></td>
						</tr>
