						...
						<table class="table table-hover" id="tbl-broiler-group">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center"><a href="<?=base_url('admin/view-broiler-group/' . encode($row->broiler_group_id))?>" class="btn btn-xs btn-success edit-broiler-group" data-id="<?=encode($row->broiler_group_id)?>">View</a></td>
					...
					<div id="broiler-config-tab" class="tab-pane fade in active">
						...
						<table class="table table-hover" id="tbl-broiler-config">
							...
							<tbody>
								...
								<tr>
									<td><?=$row->bc_name?></td>
									<td class="text-center"><a href="<?=base_url('admin/view-broiler-config/' . encode($row->bc_id))?>" class="btn btn-success btn-xs">Config</a>&nbsp;&nbsp;<a href="<?=base_url('admin/broiler-trans/' . encode($row->bc_id))?>" class="btn btn-primary btn-xs">Budget</a></td>
								</tr>
								<?php endforeach;?>
