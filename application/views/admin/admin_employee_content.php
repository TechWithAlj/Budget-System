			...
			<div class="col-lg-12" id="content">
				...
				<div id="add-btn">
					<div class="row">
								    ...
								    <div class="modal-content">
								    	<div class="modal-header">
								      	...
								      	<div class="modal-body">
								        	<form method="POST" action="<?=base_url('admin/add-employee')?>" enctype="multipart/form-data" id="add-employee">
								        		...
								        		<div class="form-group">
								        			<label>Unit</label>
								        			<select name="unit" id="emp-unit" class="form-control">
								        				<option value="">Select...</option>

									        			<?php foreach($unit as $row):?>

									        				<option value="<?=encode($row->company_unit_id)?>"><?=$row->company_unit_name?></option>
								...
								<div class="modal-dialog modal-sm">
								    <div class="modal-content">
								    	<div class="modal-header">
								      	...
								      	<div class="modal-body">
								        	<form method="POST" action="<?=base_url('admin/upload-employees')?>" enctype="multipart/form-data" id="upload-employees">
								        		<input type="hidden" name="year" value="<?=$year?>">
								        		<div class="form-group">
								        		...
								        		<div class="text-right">
								        			<a href="<?=base_url('assets/employee/Budgeting - Employee Upload Templates.xlsx')?>" target="_blank"><span class="glyphicon glyphicon-download-alt"></span>&nbsp;&nbsp;Download Employee Templates</a>
								        		</div><br /><br />						        		
						...
						<div class="col-lg-7">
							<div class="text-right">
								<a href="<?=base_url('admin/download-employees/' . $year)?>" target="_blank"><span class="glyphicon glyphicon-download-alt"></span>&nbsp;&nbsp; Download Employees</a>
							</div>
						</div>
					</div>
				...
				<table class="table table-hover" id="tbl-employee">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="" class="btn btn-success btn-xs edit-emp" data-id="<?=encode($row->emp_year_id)?>">View</a>&nbsp;&nbsp;<?=$toggle?></td>
						</tr>
					...
					<div class="modal-dialog modal-sm">
					    <div class="modal-content">
					    	<div class="modal-header">
					      	...
					      	<div class="modal-body">
					        	<form method="POST" action="<?=base_url('admin/update-employee')?>" enctype="multipart/form-data" id="update-employee">
					        		<input type="hidden" name="id" id="id">
					        		<div class="form-group">
					        			<label>First Name</label>
					        		...
					        		<div class="form-group">
					        			<label>Unit</label>
					        			<select name="unit" id="edit-emp-unit" class="form-control">
					        				<option value="">Select...</option>
					        			</select>
					        		</div>
					...
					<div class="modal-dialog modal-sm">
					    <div class="modal-content">
					    	<div class="modal-header">
					      	...
					      	<div class="modal-body">
					        	<form method="POST" action="<?=base_url('admin/deactivate-employee')?>" enctype="multipart/form-data">
					...
					<div class="modal-dialog modal-sm">
					    <div class="modal-content">
					    	<div class="modal-header">
					      	...
					      	<div class="modal-body">
					        	<form method="POST" action="<?=base_url('admin/activate-employee')?>" enctype="multipart/form-data">
					        		<input type="hidden" name="id" value="" id="id">
