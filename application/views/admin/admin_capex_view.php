			...
			<div class="col-lg-12" id="content">
				<div id="breadcrumb-div">
					<ul class="breadcrumb">
					    ...
					    <li><a href="<?=base_url('admin/capex-info/' . $cost_center_code)?>">Info</a></li>
				...
				?>
				<div id="add-btn">
					<a href="<?=base_url('admin/add-capex-item/' . $id)?>" class="btn btn-success btn-xs">+ Add Capex Item</a>
				</div>
				<div class="row">
					<div class="col-lg-3">
								...
								<div class="modal-dialog modal-sm">
								    <div class="modal-content">
								    	<div class="modal-header">
								      	...
								      	<form method="POST" action="<?=base_url('admin/remove-capex-item')?>" id="remove-capex-item">
								...
								<div class="modal-dialog" style="width:1250px;">
								    <div class="modal-content">
								    	<div class="modal-header">
								      	...
								      	<form method="POST" action="<?=base_url('admin/update-capex-item')?>" id="update-capex-item">
								      		<input type="hidden" id="id" name="id[]">
									      	<div class="modal-body">
									      		<div class="row">
