	...
	<div class="col-lg-12" id="content">
		<div id="breadcrumb-div">
			<ul class="breadcrumb">
			    ...
			    <li><a href="<?=base_url('admin/broiler-trans/' . $bc_id)?>">Broiler Transaction</a></li>
				...
				<tbody>
					...
					<?php foreach($broiler_group as $row): ?>
						...
						<tr>
							...
							<th style="text-indent: 10%;"><a href="<?=base_url('admin/view-broiler-trans/' . $bc_id .'/'. encode($row->broiler_group_id).'/'.encode($row->broiler_group_name) . '/' . $trans_year)?>" class="brn btn-xs"><?=$broiler_group_name?></a></th>
							<?php
