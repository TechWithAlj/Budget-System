<div class="col-lg-12" id="content">
    <div id="breadcrumb-div">
        <ul class="breadcrumb">
            ...
            <li><a href="<?=base_url('admin/percent-rent-maintenance/'.$bc_id)?>">Percentage Rent Maintenance</a></li>
    ...
    <form method="post" action="<?=base_url('admin/update-percent-rent')?>" id="">

        <input type="hidden" name="bc_id" value="<?=$bc_id?>">

        <label for="">Brand: <?=$percent_rent[0]->brand_name?></label><br>
        <label for="">Last Modified: <?=time_stamp_display($percent_rent[0]->percent_rent_det_added)?></label>
