			...
			<div class="col-lg-12" id="content">
				<div id="breadcrumb-div">
					<ul class="breadcrumb">
					    ...
					    <li><a href="<?=base_url('admin/brand-bc-material')?>">&nbsp;Brand BC</a></li>
					    <li><a href="<?=base_url('admin/brand-bc-info/' . $bc_id)?>">&nbsp;Info</a></li>
						    ...
						    <div class="modal-content">
						    	<div class="modal-header">
						      	...
						      	<div class="modal-body">
						        	<form method="POST" action="<?=base_url('admin/add-brand-bc-material')?>" enctype="multipart/form-data" id="add-brand-material">
					...
					<div class="modal-dialog modal-sm">
					    <div class="modal-content">
					    	<div class="modal-header">
					      	...
					      	<div class="modal-body">
					      		<form method="POST" action="<?=base_url('admin/remove-brand-bc-material')?>" enctype="multipart/form-data" id="remove-brand-bc-material">
