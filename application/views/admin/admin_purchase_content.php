			...
			<div class="col-lg-12" id="content">
					...
					<ul class="nav nav-tabs">
	  				...
	  				<div class="tab-content">
    					<div id="per-po" class="tab-pane fade in active">
							<div id="add-btn">
								<a href="<?=base_url('admin/purchase-order')?>" class="btn btn-success btn-xs">+ Place Order</a>
							</div>
							...
							<table class="table table-hover" id="tbl-po">
								...
								<tbody>
									...
									<tr>
										...
										<td><a href="<?=base_url('admin/view-po/' .encode($row->po_id))?>"><span class="glyphicon glyphicon-search" id="view"></span></a>&nbsp;&nbsp;<a href="#" data-id="<?=encode($row->po_id)?>" class="remarks-po"><span class="glyphicon glyphicon-transfer" id="remarks"></span></a>&nbsp;&nbsp;<a href="<?=base_url('admin/receive-po/' .encode($row->po_id))?>"><span class="glyphicon glyphicon-ok" id="ok"></span></a>&nbsp;&nbsp;<a href="#" data-id="<?=encode($row->po_id)?>" class="remove-po"><span class="glyphicon glyphicon-remove" id="remove"></span></a></td>
									</tr>
				...
				<div id="modal-po-remove" class="modal fade" role="dialog">
					<div class="modal-dialog modal-sm">
					    <div class="modal-content">
					    	<div class="modal-header">
					        	<button type="button" class="close" data-dismiss="modal">&times;</button>
					       		<strong>Cancel PO</strong>
					      	</div>
					      	<div class="modal-body">
					      		<form method="POST" action="<?=base_url('admin/cancel-po/')?>" id="cancel-po">
					      			<input type="hidden" name="id" id="id" value="">
						        	<div id="modal-msg" class="text-center">
						        		<label>Are you sure you want to cancel this PO?</label>
						        	</div>
					...
					<div class="modal-dialog modal-sm">
					    <div class="modal-content">
					    	<div class="modal-header">
					      	...
					      	<div class="modal-body">
					      		<form method="POST" action="<?=base_url('admin/update-remarks/')?>" id="update-remarks">
					      			<input type="hidden" name="id" id="id" value="">
