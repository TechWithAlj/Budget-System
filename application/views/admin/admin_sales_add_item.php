			...
			<div class="col-lg-12" id="content">
				<div id="breadcrumb-div">
					<ul class="breadcrumb">
					    ...
					    <li><a href="<?=base_url('admin/sales-info/' . $bc_id . '/' . $year)?>">Info</a></li>
					    <li><a href="<?=base_url('admin/sales-view/' . $id)?>">View</a></li>
				...
				<div class="row"><br />
					<div class="col-lg-12">
    					<label class="checkbox-inline">
							<input type="checkbox" data-toggle="toggle" id="toggle-qty" value="ASP" data-size="mini"> Quantity Only
						</label>
					</div>
				</div>
				...
				<form action="<?=base_url('admin/add-trans-sales-item')?>" method="POST" enctype="multipart/form-data" id="add-sales-item">
					<div class="row">
					...
					<div class="row">
						<div class="col-lg-12 text-right">
							<button class="btn-add-sales btn btn-success btn-sm">Submit</button>
						</div>
					</div><br /><br />
				</form>
