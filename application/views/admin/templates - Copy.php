...
<head>
	...
	<script src="<?=base_url()?>assets/js/admin.js?v=3.1"></script>
			...
			<div class="row">
				...
				<div id="nav">
					<ul>
						...
						<!-- <?php if($user_type == 1 || $user_type == 4):?>

							<li class="<?=$this->uri->segment(2) == 'broiler-cost' || $this->uri->segment(2) == 'new-broiler-config' || $segment == 'view-broiler-config' || $segment == 'view-broiler-group' || $segment == 'broiler-trans' || $segment == 'new-broiler-trans' || $segment == 'view-broiler-summary' || $segment == 'view-broiler-trans' || $segment == 'edit-broiler-config' || $segment == 'new-industry-trans' || $segment == 'edit-industry-trans' || $segment == 'compute-broiler-summary' ? 'active' : ''?>" style="margin:auto; text-align: center"><a href="<?=base_url('admin/broiler-cost')?>"><img height="25" width="25" src="<?=base_url()?>assets/img/icon/broiler.png" ><br>Broiler Cost</a></li>

						<?php endif;?>

						<?php if($user_type == 1 || $user_type == 5):?>

							<li class="<?=$this->uri->segment(2) == 'production-cost' || $this->uri->segment(2) == 'add-broiler-config' || ($segment == 'view-config-prod' && decode($this->uri->segment(4)) != 5) || $segment == 'prod-trans' || ($segment == 'view-prod-trans' && decode($this->uri->segment(5)) != 5) || ($segment == 'view-cost-sheet' && decode($this->uri->segment(6)) != 5) || $segment == 'new-prod-trans' || ($segment == 'edit-prod-trans' && decode($this->uri->segment(7)) != 5) || $segment == 'new-ext-prod-trans' || $segment == 'edit-ext-prod-trans' ? 'active' : ''?>" style="margin:auto; text-align: center"><a href="<?=base_url('admin/production-cost')?>"><img height="25" width="25" src="<?=base_url()?>assets/img/icon/production.png" ><br>Production Cost</a></li>

						<?php endif;?>

						<?php if($user_type == 1):?>
							
							<li class="<?=$this->uri->segment(2) == 'sales-bom' || ($segment == 'view-config-prod' && decode($this->uri->segment(4)) == 5) || $segment == 'sales-bom-trans' || $segment == 'new-sales-bom-trans' || ($segment == 'view-prod-trans' && decode($this->uri->segment(5)) == 5) || ($segment == 'view-cost-sheet' && decode($this->uri->segment(6)) == 5) || ($segment == 'edit-prod-trans' && decode($this->uri->segment(7)) == 5) ? 'active' : ''?>" style="margin:auto; text-align: center"><a href="<?=base_url('admin/sales-bom')?>"><img height="25" width="25" src="<?=base_url()?>assets/img/icon/bom.png" ><br>Sales BOM</a></li>
						...
						<?php if($user_type == 1):?>
							...
							<!-- <li class="<?=$segment == 'capex' || $segment == 'capex-info' || $segment == 'view-capex' || $segment == 'transac-capex' ||  $segment == 'add-capex-item' ? 'active' : ''?>" style="margin:auto; text-align: center"><a href="<?=base_url('admin/capex')?>"><img src="<?=base_url()?>assets/img/icon/capex.png" width="25px"><br>CAPEX</a></li>

							<li class="<?=$segment == 'opex' || $segment == 'opex-info' || $segment == 'transac-opex' ||  $segment == 'view-opex' ||  $segment == 'add-opex-item' || $segment == 'sw-view' || $segment == 'add-sw-item' || $segment == 'view-store-expense' || $segment == 'view-store-expense-item' || $segment == 'add-store-expense-item' ? 'active' : ''?>" style="margin:auto; text-align: center"><a href="<?=base_url('admin/opex')?>"><img src="<?=base_url()?>assets/img/icon/opex.png" width="25px"><br>OPEX</a></li> -->
