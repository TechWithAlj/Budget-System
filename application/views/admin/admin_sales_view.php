			...
			<div class="col-lg-12" id="content">
				<div id="breadcrumb-div">
					<ul class="breadcrumb">
					    ...
					    <li><a href="<?=base_url('admin/sales-info/' . encode($bc_id) . '/' . $year)?>">Info</a></li>
				...
				<div id="add-btn">
					<a href="<?=base_url('admin/add-sales-item/' . encode($id))?>" class="btn btn-success btn-xs">+ Add Sales Item</a>
				</div>

				<div class="row">
					<div class="col-lg-3">
						<label id="data-info">Outlet Name: <?=$outlet_name . ' - ' . $brand_name?></label>
					</div>
					<div class="col-lg-3">
				...
				<div class="table-responsive">
					<table class="table table-bordered table-stripe nowrap" id="tbl-sales-view" style="width:100%">
						...
						<tbody>
							...
							<tr>
								<td><a href="" class="remove-sales-item remove" data-id="<?=encode($row->sales_item_id)?>"><span class="fa fa-remove"></span></a>&nbsp;&nbsp;&nbsp;<a href="" class="update update-sales-item" data-id="<?=encode($row->sales_item_id)?>"><span class="fa fa-pencil"></span></a></td>
					    ...
					    <div class="modal-content">
					    	<div class="modal-header">
					      	...
					      	<div class="modal-body">
					      		<form method="POST" action="<?=base_url('admin/remove-sales-item')?>" enctype="multipart/form-data" id="remove-sales-item">
					...
					<div class="modal-dialog" style="width:1250px;">
					    <div class="modal-content">
					    	<div class="modal-header">
					      	...
					      	<form method="POST" action="<?=base_url('admin/update-sales-item')?>" id="update-sales-item">
