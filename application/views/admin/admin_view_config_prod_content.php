			<div class="col-lg-12" id="content">
				<div id="breadcrumb-div">
					<ul class="breadcrumb">
					    ...
					    <li><a href="<?=base_url('admin/sales-bom#prod-group-tab')?>">Sales BOM</a></li>
					    <li class="active">Sales BOm Details</li>
					    <?php } else { ?>
					    <li><a href="<?=base_url('admin/production-cost#prod-group-tab')?>">Production Cost</a></li>
				...
				<div id="add-btn">
					<a href="#" data-toggle="modal" data-target="#modal-production-subgroup" class="btn btn-success btn-xs">+ Add Config Item (Material)</a>
					&nbsp;&nbsp;
					<a href="#" data-toggle="modal" data-target="#modal-production-subgroup-services" class="btn btn-success btn-xs">+ Add Config Item (Services)</a>&nbsp;&nbsp;
					<a href="" class="btn btn-info btn-xs" data-toggle="modal" data-backdrop="static" data-target="#modal-upload-prod-config-details">+ Upload Config Items</a>

					<div id="modal-upload-prod-config-details" class="modal fade" role="dialog">
						<div class="modal-dialog modal-md">
						    <div class="modal-content">
						    	<div class="modal-header">
						        	<button type="button" class="close" data-dismiss="modal">&times;</button>
						       		<strong>Upload Config Items</strong>
						      	</div>
						      	<div class="modal-body">
						        	<form method="POST" action="<?=base_url('admin/upload-config-prod-dtl')?>" enctype="multipart/form-data" id="upload-materials">
						        		...
						        		<div class="text-right">
						        			<a href="<?=base_url('assets/production-group-temp/Production Group Details Upload Template.xlsx')?>" target="_blank"><span class="glyphicon glyphicon-download-alt"></span>&nbsp;&nbsp;Download Templates</a>
						        		</div><br /><br />

										<div class="text-right">
						        			<a href="<?=base_url('admin/download-prod-config-guide/0')?>" target="_blank"><span class="glyphicon glyphicon-download-alt"></span>&nbsp;&nbsp;Download Config Details</a>
						        		</div><br /><br />
						...
						<div class="modal-dialog modal-sm">
						    <div class="modal-content">
						    	<div class="modal-header">
						      	...
						      	<div class="modal-body">
						      		<form method="POST" action="<?=base_url('admin/remove-config-prod-dtl')?>" enctype="multipart/form-data" id="remove-config-prod-dtl">
				...
				<div class="table-responsive">
					<table class="table table-hover table-bordered table-stripe nowrap" id="tbl-broiler-group">
						...
						$material_desc = $row->material_code != '' ? $row->material_code.' - '.$row->material_desc : $row->material_desc;
						?>
							...
							<tr>
								...
								<td><?=$row->unit_name?></td>
								<td><?=$row->config_prod_dtl_rate?></td>
