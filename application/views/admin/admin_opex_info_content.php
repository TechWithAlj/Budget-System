				...
				<div class="row">
					...
					<div class="col-lg-7">
						<div class="text-right">
							<a href="<?=base_url('admin/download-opex/' . $cost_center . '/' . $year)?>" target="_blank"><span class="glyphicon glyphicon-download-alt"></span>&nbsp;&nbsp; Download OPEX</a>
						</div>
					</div>
				...
				<ul class="nav nav-tabs">
  				...
  				<div class="tab-content">
    				...
    				<div id="opex-tab" class="tab-pane fade in active"><br/ >
						<div id="add-btn">
							<a href="<?=base_url('admin/transac-opex/' . $id . '/' . $year . '/' .encode('2'))?>" class="btn btn-success btn-xs">+ Add Opex Unit</a>&nbsp;
							<a href="<?=base_url('admin/transac-opex/' . $id . '/' . $year . '/' .encode('1'))?>" class="btn btn-success btn-xs">+ Add Opex Store</a>&nbsp;
						</div>
						<table class="table table-hover" id="tbl-opex-info">
							...
							<tbody>
								...
								<tr>
									...
									<td></td>
									<td>
										<a href="<?=base_url('admin/view-opex/' . encode($row->gl_trans_id))?>" class="btn btn-success btn-xs">View Opex Unit</a>&nbsp;&nbsp;
										<a href="<?=base_url('admin/view-store-expense/' . encode($row->gl_trans_id) . '/'. $id . '/' . $year )?>" class="btn btn-success btn-xs">View Opex Store</a>&nbsp;&nbsp;
								...
								?>	
									<tr>
										...
										<td></td>
										<td><a href="<?=base_url('admin/sw-view/' . encode($row_sw->emp_salary_trans_id))?>" class="btn btn-success btn-xs">View</a>&nbsp;&nbsp;<a data-id="<?=encode($row_sw->emp_salary_trans_id)?>" class="btn btn-danger btn-xs cancel-sw-btn">Cancel</a></td>
									</tr>
					...
					<!-- <div id="direct-labor-tab" class="tab-pane fade in active"><br/ >
						<div id="add-btn">
							<a href="<?=base_url('admin/transac-opex/' . $id . '/' . $year . '/' .encode('1') .'/0/0/'.encode('1'))?>" class="btn btn-success btn-xs">+ Add Direct Labor</a>&nbsp;
						</div>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										<a href="<?=base_url('admin/view-store-expense/' . encode($row->gl_trans_id) . '/'. $id . '/' . $year .'/'. encode('1') )?>" class="btn btn-success btn-xs">View Direct Labor</a>&nbsp;&nbsp;
							...
							<div class="modal-dialog modal-sm">
							    <div class="modal-content">
							    	<div class="modal-header">
							      	...
							      	<div class="modal-body">
							      		<form method="POST" action="<?=base_url('admin/cancel-opex')?>" enctype="multipart/form-data" id="cancel-direct-labor">
							      			<input type="hidden" name="id" id="id">
			...
			<script type="text/javascript">
				$(document).ready(function(){
					...
					function amount_per_gl(){
						var url = base_url + 'admin/opex-donut/' + id + '/' + year;
						$.ajax({
					    	url: url,
					    	method: 'GET',
					...
					function amount_per_month(){
						var url = base_url + 'admin/opex-line/' + id + '/' + year;
						$.ajax({
					    	url: url,
					    	method: 'GET',
					    	success:function(response){
					...
					function amount_per_month_group(){
						var id = $('#id').val();
						var url = base_url + 'admin/opex-bar/' + id + '/' + year;
