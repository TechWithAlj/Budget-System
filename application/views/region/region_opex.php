			...
			<div class="col-lg-12" id="content">
				...
				<ul class="nav nav-tabs">
				    ...
				    <li><a data-toggle="tab" href="#unit-tab">Unit</a></li>
  				...
  				<div class="tab-content">
						...
						<table class="table table-hover" id="tbl-opex">
							...
							<tbody>
								...
								<tr>
									...
									<td></td>
									<td><a href="<?=base_url('region/opex-info/' . encode($row->cost_center_code)) . '/' . $active_year?>" class="btn btn-success btn-xs">View</a></td>
								</tr>
					...
					<div id="unit-tab" class="tab-pane fade"><br/ >
						<table class="table table-hover" id="tbl-opex-unit">
							<thead>
								<tr>
									<th>Unit </th>
									<th>Action</th>
							...
							<tbody>
								...
								<tr>
									...
									<td><a href="<?=base_url('region/opex-info/' . encode($row->cost_center))?>" class="btn btn-success btn-xs">View</a></td>
								</tr>
