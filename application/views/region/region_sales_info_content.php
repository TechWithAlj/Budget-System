			...
			<div class="col-lg-12" id="content">
				<div id="breadcrumb-div">
					<ul class="breadcrumb">
					    ...
					    <li><a href="<?=base_url('region/sales')?>">&nbsp;&nbsp;Sales</a></li>
				...
				<div class="row">
					...
					<div class="col-lg-7">
						<div class="text-right">
							<a href="<?=base_url('region/download-sales/' . $id . '/' . $year)?>" target="_blank"><span class="glyphicon glyphicon-download-alt"></span>&nbsp;&nbsp; Download Sales</a>
						</div>
					</div>
						    ...
						    <div class="modal-content">
						    	<div class="modal-header">
						      	...
						      	<div class="modal-body">
						        	<form method="POST" action="<?=base_url('region/add-outlet')?>" enctype="multipart/form-data" id="add-outlet">
						...
						<div class="modal-dialog modal-sm">
						    <div class="modal-content">
						    	<div class="modal-header">
						      	...
						      	<div class="modal-body">
						        	<form method="POST" action="<?=base_url('region/upload-sales')?>" enctype="multipart/form-data" id="add-outlet">
				...
				<div class="tab-content">
						...
						<table class="table table-hover" id="tbl-sales-info">
							...
							<tbody>
								...
								<tr>
									...
									<td><a href="<?=base_url('region/sales-view/' . encode($row->sales_id))?>" class="btn btn-xs btn-success" data-id="<?=encode($row->outlet_id)?>">View</a><!-- &nbsp;&nbsp;<a data-id="<?=encode($row->sales_id)?>" class="btn btn-danger btn-xs cancel-sales-btn">Cancel</a> --></td>
								</tr>
							...
							<div class="modal-dialog modal-sm">
							    <div class="modal-content">
							    	<div class="modal-header">
							      	...
							      	<div class="modal-body">
							      		<form method="POST" action="<?=base_url('region/cancel-sales')?>" enctype="multipart/form-data" id="cancel-sales">
							...
							<div class="modal-dialog modal-sm">
							    <div class="modal-content">
							    	<div class="modal-header">
							      	...
							      	<div class="modal-body">
							      		<form method="POST" action="<?=base_url('region/cancel-sales-batch')?>" enctype="multipart/form-data" id="cancel-sales">
					...
					<div id="unbudgeted-tab" class="tab-pane fade"><br/ >
						<div id="add-btn">
							...
							<a href="<?=base_url('region/download-sales-templates/' . $id . '/' . $first . '/' . $year)?>" id="templates-link" class="btn btn-info" target="_blank"><span class="fa fa-download"></span>&nbsp;&nbsp;Download Templates</a> -->
						</div>
						<table class="table table-hover" id="tbl-unbudgeted">
							...
							<tbody>
								...
								<tr>
									...
									<td><?=$row->bc_name?></td>
									<td><?=$row->outlet_type_name?></td>
									<td><a href="<?=base_url('region/outlet-budget/' . encode($row->outlet_id) . '/' . $year)?>" class="btn btn-xs btn-info" data-id="<?=encode($row->outlet_id)?>">Budget</a></td>
								</tr>
					...
					<div class="modal-dialog modal-sm">
					    <div class="modal-content">
					    	<div class="modal-header">
					      	...
					      	<div class="modal-body">
					        	<form method="POST" action="<?=base_url('region/update-category')?>" enctype="multipart/form-data" id="update-category">
			...
			<script type="text/javascript">
				$(document).ready(function(){
					...
					function sales_unit_dashboard(){
						var url = base_url + 'region/get-sales-info-unit/';
						$.ajax({
					    	url: url,
					...
					function sales_dashboard(){
						var url = base_url + 'region/get-sales-info-net-sales/';
						$.ajax({
					    	url: url,
					    	data:{id:id, year:year},
					    	method: 'POST',
