			...
			<div class="col-lg-12" id="content">
				<div id="breadcrumb-div">
					<ul class="breadcrumb">
					    ...
					    <li><a href="<?=base_url('region/opex-info/' . $parent)?>">Info</a></li>
					    <li><a href="<?=base_url('region/view-store-expense/' . $gl_trans_id)?>">View Store Expenses</a></li>
				...
				<div id="add-btn">
					<!-- <a href="<?=base_url('region/add-store-expense-item/' . $id . '/' . $year)?>" class="btn btn-success btn-xs">+ Add Store Expense</a> -->
				</div>
							...
							<table class="table table-bordered" id="tbl-view-capex">
								...
								<tbody>
									...
									?>
										...
										<tr>
											<td><!-- <a href="" class="remove-opex-item remove" data-id="<?=encode($row->gl_trans_item_id)?>"><span class="fa fa-remove"></span></a>&nbsp;&nbsp;&nbsp;<a href="" class="update update-store-expense-btn" data-id="<?=encode($row->gl_trans_item_id)?>"><span class="fa fa-pencil"></span></a> --></td>
								...
								<div class="modal-dialog modal-sm">
								    <div class="modal-content">
								    	<div class="modal-header">
								      	...
								      	<form method="POST" action="<?=base_url('region/remove-store-expense-item')?>" id="remove-opex-item">
							...
							<div id="modal-update-opex-item" class="modal fade modal-confirm" role="dialog">
								<div class="modal-dialog" style="width:1250px;">
								    <div class="modal-content">
								    	<div class="modal-header">
								        	<button type="button" class="close" data-dismiss="modal">&times;</button>
								       		<strong>Update Store Expense</strong>
								      	</div>
								      	<form method="POST" action="<?=base_url('region/update-store-expense-item')?>" id="update-store-expense-item">
								      		<input type="hidden" id="id" name="id[]">
									      	<div class="modal-body">
									      		<div class="row">
