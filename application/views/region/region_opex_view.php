			...
			<div class="col-lg-12" id="content">
				<div id="breadcrumb-div">
					<ul class="breadcrumb">
					    ...
					    <li><a href="<?=base_url('region/opex-info/' . $cost_center_code)?>">Info</a></li>
				...
				<div id="add-btn">
					<!-- <a href="<?=base_url('region/add-opex-item/' . $id)?>" class="btn btn-success btn-xs">+ Add Opex Item</a> -->
				</div>
				...
				<div class="row">
					...
					<div class="col-lg-4">
						<label class="data-info">Budget Year: <strong><span id="year-label"><?=$year?></span></strong></label>
					</div>
							...
							<table class="table table-bordered" id="tbl-view-capex">
								...
								<tbody>
									...
									?>
										...
										<tr>
											<td><!-- <a href="" class="remove-opex-item remove" data-id="<?=encode($row->gl_trans_item_id)?>"><span class="fa fa-remove"></span></a>&nbsp;&nbsp;&nbsp;<a href="" class="update update-opex-item" data-id="<?=encode($row->gl_trans_item_id)?>"><span class="fa fa-pencil"></span></a> --></td>
								...
								<div class="modal-dialog modal-sm">
								    <div class="modal-content">
								    	<div class="modal-header">
								      	...
								      	<form method="POST" action="<?=base_url('region/remove-opex-item')?>" id="remove-opex-item">
								...
								<div class="modal-dialog" style="width:1250px;">
								    <div class="modal-content">
								    	<div class="modal-header">
								      	...
								      	<form method="POST" action="<?=base_url('region/update-opex-item')?>" id="update-opex-item">
								      		<input type="hidden" id="id" name="id[]">
									      	<div class="modal-body">
									      		<div class="row">
