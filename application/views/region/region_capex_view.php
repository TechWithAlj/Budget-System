			...
			<div class="col-lg-12" id="content">
				<div id="breadcrumb-div">
					<ul class="breadcrumb">
					    ...
					    <li><a href="<?=base_url('region/capex-info/' . $cost_center_code)?>">Info</a></li>
				...
				?>
				<div id="add-btn">
					<!-- <a href="<?=base_url('region/add-capex-item/' . $id)?>" class="btn btn-success btn-xs">+ Add Capex Item</a> -->
				</div>
				<div class="row">
					<div class="col-lg-3">
					...
					<div class="col-lg-3">
						<label class="data-info">Grand Total: <span id="capex-grand-total"></span></label>
					</div>
					...
					<div class="col-lg-12">
						<div class="table-responsive">
							<table class="table table-bordered" id="tbl-view-capex">
								...
								<tbody>
									...
									?>
										...
										<tr>
											<td><!-- <a href="" class="remove remove-trans-item" data-id="<?=encode($row->ag_trans_item_id)?>"><span class="fa fa-remove"></span></a>&nbsp;&nbsp;&nbsp;<a href="" class="update update-trans-item" data-id="<?=encode($row->ag_trans_item_id)?>"><span class="fa fa-pencil"></span></a> --></td>
											<td><?=$row->asg_name?></td>
							...
							<script type="text/javascript">
								$('#capex-grand-total').empty();
								$('#capex-grand-total').text('<?=number_format($grand_total, 2)?>');
							</script>
								...
								<div class="modal-dialog modal-sm">
								    <div class="modal-content">
								    	<div class="modal-header">
								      	...
								      	<form method="POST" action="<?=base_url('region/remove-capex-item')?>" id="remove-capex-item">
								...
								<div class="modal-dialog" style="width:1250px;">
								    <div class="modal-content">
								    	<div class="modal-header">
								      	...
								      	<form method="POST" action="<?=base_url('region/update-capex-item')?>" id="update-capex-item">
								      		<input type="hidden" id="id" name="id[]">
									      	<div class="modal-body">
									      		<div class="row">
									      			...
									      			<div class="col-lg-12">
														<div class="table-responsive">
												      		<table class="table" id="tbl-update-capex">
																...
																<tbody>
																	<tr>
																		<td class=""><input type="text" class="asset-price update-capex-qty" name="price[]"></td>
