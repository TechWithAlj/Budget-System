						...
						<div class="modal-dialog modal-sm">
						    <div class="modal-content">
						    	<div class="modal-header">
						      	...
						      	<div class="modal-body">
						        	<form method="POST" action="<?=base_url('region/upload-budget')?>" enctype="multipart/form-data" id="add-outlet">
				...
				<table class="table table-hover" id="tbl-sales">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="<?=base_url('region/sales-info/' . encode($row->bc_id) . '/' . $year)?>" class="btn btn-xs btn-info">View</a></td>
						</tr>
