			...
			<div class="row">
				...
				<div id="nav">
					...
					<ul>
						...
						<li class="<?=$this->uri->segment(2) == 'region' ? 'active' : ''?>" style="margin:auto; text-align: center"><a href="<?=base_url('region/')?>"><img src="<?=base_url()?>assets/img/icon/dashboard.png" width="25px"><br>Dashboard</a></li>
						...
						<li class="dropdown <?=$this->uri->segment(2) == 'sales' || $this->uri->segment(2) == 'outlet-brand' || $this->uri->segment(2) == 'outlet-budget' || $segment == 'sales-info' || $segment == 'sales-view' ? 'active' : ''?>" style="margin:auto; text-align: center">
							...
							<!--  <li><a href="<?=base_url('region/sales-bom')?>">Sales BOM</a></li>
								<li><a href="<?=base_url('region/broiler-cost')?>">Broiler Cost</a></li>
								<li><a href="<?=base_url('region/production-cost')?>">Product Cost</a></li>
								<li><a href="<?=base_url('region/tactical-price')?>">Tactical Discount</a></li>
								<li><a href="<?=base_url('region/live-alw')?>">ALW For Live</a></li>
								<li><a href="<?=base_url('region/manpower')?>">Manpower</a></li> -->
							</ul>

						</li>
						
						<li class="<?=$this->uri->segment(2) == 'logout' ? 'active' : ''?>" style="margin:auto; text-align: center"><a href="<?=base_url('region/logout')?>"><img src="<?=base_url()?>assets/img/icon/logout.png" width="24px" height="24px"><br>Logout</a></li>
					</ul>
