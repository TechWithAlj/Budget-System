...
$(document).ready(function () {
	...
	$(document).on("change", "#brand-templates", function () {
		...
		var url =
			base_url +
			"business-center/download-sales-templates/" +
			bc_id +
			"/" +
			brand_id +
			"/" +
			...
			success: function (response) {
				...
				if (parse_response["result"] == 1) {
					...
					if (gl_val == "STORE EXPENSES") {
						...
						$("#add-opex-form").attr(
							"action",
							base_url + "business-center/add-store-expense"
						);
					} else {
						...
						$("#add-opex-form").attr(
							"action",
							base_url + "business-center/add-opex"
						);
					}
	...
	$(document).on("change", "#opex-brand", function () {
		...
		var url =
			base_url +
			"business-center/download-store-expense/" +
			brand +
			"/" +
			year +
			"/" +
	...
	$(document).on("change", "#opex-gl-class", function () {
		...
		$.ajax({
			url:
				base_url +
				"business-center/get-gl-base-on-class/" +
				id +
				"/" +
				cost_center,
			// data: {id:id, cost_center:cost_center},
	...
	$("#broiler-budget-date-year")
		...
		.on("changeDate", function (e) {
			...
			var url =
				base_url + "business-center/broiler-trans/" + bc_id + "/" + year;
					...
					if (parse_response["result"] == 1) {
						...
						if (parse_response["pending_lock_status"]) {
							...
							$("#add_broiler_trans_button").attr(
								"href",
								base_url +
									"business-center/new-broiler-trans/" +
									bc_id +
									"/" +
									year
							);
							...
							$("#view_broiler_summary").attr(
								"href",
								base_url +
									"business-center/view-broiler-summary/" +
									bc_id +
									"/0/" +
									year
							);
					...
					if (parse_response["result"] == 1) {
						...
						if (parse_response["pending_lock_status"]) {
							...
							$("#add_sales_bom_trans_button").attr(
								"href",
								base_url +
									"business-center/new-sales-bom-trans/" +
									bc_id +
									"/" +
									year
							);
							$("#view_sales_bom_summary_button").attr(
								"href",
								base_url +
									"business-center/view-sales-bom-summary/" +
									bc_id +
									"/" +
									year
							);
							$("#create_by_product_on_sales_bom").attr(
								"href",
								base_url +
									"business-center/create-by-product-on-sales-bom/" +
									bc_id +
									"/" +
									year
							);
