...
$(document).ready(function () {
	...
	$("#tbl-users-region").DataTable({
		bInfo: false,
		order: [],
	});

	$("#tbl-users-national").DataTable({
		bInfo: false,
		order: [],
	});
	...
	var tbl_sales = $("#tbl-sales").DataTable();
	...
	$("#tbl-user-ahg").DataTable({
		bInfo: false,
		order: [],
	});

	$("#tbl-user-prod").DataTable({
		bInfo: false,
		order: [],
	});
	...
	$(document).on("click", ".edit-user-admin", function (e) {
		e.preventDefault();

		var id = $(this).attr("data-id");

		$.ajax({
			url: base_url + "admin/modal-user-admin/" + id,
			method: "GET",
			success: function (response) {
				var parse_response = JSON.parse(response);

				if (parse_response["result"] == 1) {
					var id = parse_response["info"]["id"];
					var fname = parse_response["info"]["fname"];
					var lname = parse_response["info"]["lname"];
					var email = parse_response["info"]["email"];
					var emp_no = parse_response["info"]["emp_no"];

					$("#update-user-admin").find("#id").val(id);
					$("#update-user-admin").find("#fname").val(fname);
					$("#update-user-admin").find("#lname").val(lname);
					$("#update-user-admin").find("#email").val(email);
					$("#update-user-admin").find("#emp_id").val(emp_no);
					$("#modal-edit-user-admin").modal({ show: true });
				} else {
	...
	$(document).on("click", ".edit-user-bc", function (e) {
		e.preventDefault();

		var id = $(this).attr("data-id");

		$.ajax({
			url: base_url + "admin/modal-user-bc/" + id,
			method: "GET",
			success: function (response) {
				var parse_response = JSON.parse(response);
				...
				if (parse_response["result"] == 1) {
					...
					var email = parse_response["info"]["email"];
					var emp_no = parse_response["info"]["emp_no"];
					var bc = parse_response["info"]["bc"];

					$("#update-user-bc").find("#id").val(id);
					$("#update-user-bc").find("#fname").val(fname);
					$("#update-user-bc").find("#lname").val(lname);
					$("#update-user-bc").find("#email").val(email);
					$("#update-user-bc").find("#emp_id").val(emp_no);

					$("#update-user-bc").find("#bc").empty();
					$("#update-user-bc").find("#bc").append(bc);

					$("#modal-edit-user-bc").modal({ show: true });
				} else {
					console.log("Error please contact your administrator.");
				}
			},
	...
	$(document).on("click", ".edit-user-unit", function (e) {
		e.preventDefault();

		var id = $(this).attr("data-id");

		$.ajax({
			url: base_url + "admin/modal-user-unit/" + id,
			method: "GET",
			success: function (response) {
				var parse_response = JSON.parse(response);
				...
				if (parse_response["result"] == 1) {
					...
					$("#update-user-unit").find("#id").val(id);
					$("#update-user-unit").find("#fname").val(fname);
					$("#update-user-unit").find("#lname").val(lname);
					$("#update-user-unit").find("#email").val(email);
					$("#update-user-unit").find("#emp_id").val(emp_no);

					$("#update-user-unit").find("#unit").empty();
					$("#update-user-unit").find("#unit").append(unit);

					$("#modal-edit-user-unit").modal({ show: true });
				} else {
					console.log("Error please contact your administrator.");
				}
			},
	...
	$(document).on("click", ".edit-user-region", function (e) {
		e.preventDefault();

		var id = $(this).attr("data-id");

		$.ajax({
			url: base_url + "admin/modal-user-region/" + id,
			method: "GET",
			success: function (response) {
				var parse_response = JSON.parse(response);
				...
				if (parse_response["result"] == 1) {
					...
					var email = parse_response["info"]["email"];
					var emp_no = parse_response["info"]["emp_no"];
					var region = parse_response["info"]["region"];

					$("#update-user-region").find("#id").val(id);
					$("#update-user-region").find("#fname").val(fname);
					$("#update-user-region").find("#lname").val(lname);
					$("#update-user-region").find("#email").val(email);
					$("#update-user-region").find("#emp_id").val(emp_no);

					$("#update-user-region").find("#region").empty();
					$("#update-user-region").find("#region").append(region);

					$("#modal-edit-user-region").modal({ show: true });
				} else {
					console.log("Error please contact your administrator.");
				}
			},
	...
	$(document).on("click", ".edit-measurement", function (e) {
		...
		$.ajax({
			url: base_url + "admin/modal-measurement/" + id,
			method: "GET",
			success: function (response) {
				var parse_response = JSON.parse(response);
				...
				if (parse_response["result"] == 1) {
					...
					$("#update-measurement")
						.find("#measurement")
						.val(parse_response["info"].measurement);
	...
	/*Asset*/
	$(document).on("click", ".edit-asset-group", function (e) {
		e.preventDefault();

		var id = $(this).attr("data-id");

		$.ajax({
			url: base_url + "admin/modal-asset-group/",
			data: { id: id },
			method: "POST",
			success: function (response) {
				var parse_response = JSON.parse(response);
				var name = parse_response["info"]["name"];
				var code = parse_response["info"]["code"];
				var color = parse_response["info"]["color"];

				if (parse_response["result"] == 1) {
					$("#update-asset-group").find("#id").val(id);
					$("#update-asset-group").find("#edit-asset-group").val(name);
					$("#update-asset-group").find("#edit-asset-code").val(code);
					$("#update-asset-group").find("#edit-asset-color").val(color);
					$("#modal-edit-asset-group").modal({ show: true });
				} else {
					console.log("Error please contact your administrator.");
				}
			},
	...
	$(document).on("click", ".edit-asset-subgroup", function (e) {
		e.preventDefault();

		var id = $(this).attr("data-id");

		$.ajax({
			url: base_url + "admin/modal-asset-subgroup/",
			data: { id: id },
			method: "POST",
			success: function (response) {
				var parse_response = JSON.parse(response);
				...
				var lifespan = parse_response["info"]["lifespan"];

				if (parse_response["result"] == 1) {
					$("#update-asset-subgroup").find("#id").val(id);

					$("#update-asset-subgroup").find("#edit-ag").empty();
					$("#update-asset-subgroup").find("#edit-ag").append(asset_group);
					$("#update-asset-subgroup").find("#edit-asset-subgroup").val(name);
					$("#update-asset-subgroup")
						.find("#edit-asset-subgroup-price")
						.val(price);
					$("#update-asset-subgroup")
						.find("#edit-asset-subgroup-useful-life")
						.val(lifespan);
					$("#modal-edit-asset-subgroup").modal({ show: true });
				} else {
					console.log("Error please contact your administrator.");
				}
			},
	...
	$(document).on("click", ".edit-gl-group", function (e) {
		e.preventDefault();

		var id = $(this).attr("data-id");

		$.ajax({
			url: base_url + "admin/modal-gl-group/",
			data: { id: id },
			method: "POST",
			success: function (response) {
				var parse_response = JSON.parse(response);
				...
				if (parse_response["result"] == 1) {
					...
					$("#update-gl-group").find("#id").val(id);
					$("#update-gl-group").find("#edit-gl-group").val(name);
					$("#modal-edit-gl-group").modal({ show: true });
				} else {
					console.log("Error please contact your administrator.");
				}
			},
	...
	$(document).on("click", ".edit-gl-subgroup", function (e) {
		e.preventDefault();

		var id = $(this).attr("data-id");

		$.ajax({
			url: base_url + "admin/modal-gl-subgroup/",
			data: { id: id },
			method: "POST",
			success: function (response) {
				var parse_response = JSON.parse(response);
				...
				if (parse_response["result"] == 1) {
					...
					$("#update-gl-subgroup").find("#id").val(id);
					$("#update-gl-subgroup").find("#edit-gl-group-select").empty();
					$("#update-gl-subgroup")
						.find("#edit-gl-group-select")
						.append(gl_group);
					$("#update-gl-subgroup").find("#edit-gl-subgroup").val(name);
					$("#update-gl-subgroup").find("#edit-gl-subgroup-code").val(code);
					$("#modal-edit-gl-subgroup").modal({ show: true });
				} else {
					console.log("Error please contact your administrator.");
				}
			},
	...
	$(document).on("click", ".deactivate-gl-sub", function (e) {
		e.preventDefault();
		var id = $(this).attr("data-id");
		$("#modal-deactivate-gl-sub").find("#id").val(id);
		$("#modal-deactivate-gl-sub").modal({ show: true });
	});

	$(document).on("click", ".activate-gl-sub", function (e) {
		e.preventDefault();
		var id = $(this).attr("data-id");
		$("#modal-activate-gl-sub").find("#id").val(id);
		$("#modal-activate-gl-sub").modal({ show: true });
	});

	$(document).on("click", ".deactivate-gl-group", function (e) {
		e.preventDefault();
		var id = $(this).attr("data-id");
		$("#modal-deactivate-gl-group").find("#id").val(id);
		$("#modal-deactivate-gl-group").modal({ show: true });
	});

	$(document).on("click", ".activate-gl-group", function (e) {
		e.preventDefault();
		var id = $(this).attr("data-id");
		$("#modal-activate-gl-group").find("#id").val(id);
		$("#modal-activate-gl-group").modal({ show: true });
	});
	...
	var tbl_sales_info = $("#tbl-sales-info").DataTable({
		bInfo: false,
		order: [],
		autoWidth: false,
		columnDefs: [
	...
	$(document).on("click", "#btn-cancel-sales", function (e) {
		e.preventDefault();

		var bc_id = $("#bc_id").val();
		var rows_selected = tbl_sales_info.column(0).checkboxes.selected();
		$("#sales-cancel-id").empty();
		var count = 0;
		$.each(rows_selected, function (index, rowId) {
			var id = '<input type="hidden" name="id[]" value="' + rowId + '">';
			$("#sales-cancel-id").append(id);
			count++;
		});

		var bc = '<input type="hidden" name="bc_id" value="' + bc_id + '">';
		$("#sales-cancel-id").append(bc);

		$("#cancel-count").empty();
		$("#cancel-count").append(count);

		$("#modal-cancel-sales-batch").modal("show");
	});
	...
	$(document).on("change", "#sales-trans-year", function (e) {
		...
		var url = base_url + "admin/sales-info/" + bc_id + "/" + year;
		window.location = url;
	});

	$("#status, #bc, #brand").change(function () {
		var status = $("#status").children("option:selected").text();
		...
		if (status == "NEW") {
			if (status !== "" && bc !== "" && brand !== "") {
				$.ajax({
					url: base_url + "admin/get-new-outlet/" + bc + "/" + brand,
					method: "GET",
					success: function (response) {
						var parse_response = JSON.parse(response);
						if (parse_response["result"] == 1) {
			...
			$("#outlet").attr("readonly", false);
			$("#outlet").val("");

			$("#ifs").attr("readonly", false);
			$("#ifs").val("");
		}
	});
	...
	$(document).on("click", ".update-sales-item", function (e) {
		...
		var id = $(this).attr("data-id");
		$.ajax({
			url: base_url + "admin/get-sales-item/",
			data: { id: id },
			method: "POST",
			success: function (response) {
				var parse_response = JSON.parse(response);
	...
	$(document).on("change", "#brand-templates", function () {
		...
		var url =
			base_url +
			"admin/download-sales-templates/" +
			bc_id +
			"/" +
			brand_id +
			"/" +
	...
	$(document).on("keyup", ".sales-qty", function () {
		...
		if ($.isNumeric(val) || val == "") {
			if (Math.floor(val) >= 0) {
				...
				total_qty +=
					parseFloat(
						$(this).parent().parent().parent().find(".budget-qty-jan").val()
					) || 0;
				total_qty +=
					parseFloat(
						$(this).parent().parent().parent().find(".budget-qty-feb").val()
					) || 0;
				total_qty +=
					parseFloat(
						$(this).parent().parent().parent().find(".budget-qty-mar").val()
					) || 0;
				total_qty +=
					parseFloat(
						$(this).parent().parent().parent().find(".budget-qty-apr").val()
					) || 0;
				total_qty +=
					parseFloat(
						$(this).parent().parent().parent().find(".budget-qty-may").val()
					) || 0;
				total_qty +=
					parseFloat(
						$(this).parent().parent().parent().find(".budget-qty-jun").val()
					) || 0;
				total_qty +=
					parseFloat(
						$(this).parent().parent().parent().find(".budget-qty-jul").val()
					) || 0;
				total_qty +=
					parseFloat(
						$(this).parent().parent().parent().find(".budget-qty-aug").val()
					) || 0;
				total_qty +=
					parseFloat(
						$(this).parent().parent().parent().find(".budget-qty-sep").val()
					) || 0;
				total_qty +=
					parseFloat(
						$(this).parent().parent().parent().find(".budget-qty-oct").val()
					) || 0;
				total_qty +=
					parseFloat(
						$(this).parent().parent().parent().find(".budget-qty-nov").val()
					) || 0;
				total_qty +=
					parseFloat(
						$(this).parent().parent().parent().find(".budget-qty-dec").val()
					) || 0;
	...
	$("#add-sales").submit(function (e) {
		...
		var check_asp = validate_sales_asp();
		if (check_qty && check_asp) {
			var check_modal = ($("#modal-confirm-sales").data("bs.modal") || {})
				.isShown;
			if (!check_modal) {
				e.preventDefault();
	...
	$(document).on("keyup", ".budget-qty-jan", function () {
		...
		var loc = $(this)
			...
			.parent()
			.siblings(".budget-td")
			.find(".weight-unit-jan");
		var loc_equivalent = $(this)
			.parent()
			.parent()
			.siblings(".budget-td")
			.find(".equivalent-unit-jan");
		var asp = $(this)
			.parent()
			.parent()
			.siblings(".budget-td")
			...
			.val();
		$.ajax({
			url: base_url + "admin/material-info/",
	...
	$(document).on("keyup", ".budget-qty-feb", function () {
		...
		var loc = $(this)
			...
			.parent()
			.siblings(".budget-td")
			.find(".weight-unit-feb");
		var loc_equivalent = $(this)
			.parent()
			.parent()
			.siblings(".budget-td")
			.find(".equivalent-unit-feb");
		var asp = $(this)
			.parent()
			.parent()
			.siblings(".budget-td")
	...
	$(document).on("keyup", ".budget-qty-mar", function () {
		...
		var loc = $(this)
			...
			.parent()
			.siblings(".budget-td")
			.find(".weight-unit-mar");
		var loc_equivalent = $(this)
			.parent()
			.parent()
			.siblings(".budget-td")
			.find(".equivalent-unit-mar");
		var asp = $(this)
			.parent()
			.parent()
			.siblings(".budget-td")
	...
	$(document).on("keyup", ".budget-qty-apr", function () {
		...
		var loc = $(this)
			...
			.parent()
			.siblings(".budget-td")
			.find(".weight-unit-apr");
		var loc_equivalent = $(this)
			.parent()
			.parent()
			.siblings(".budget-td")
			.find(".equivalent-unit-apr");
		var asp = $(this)
			.parent()
			.parent()
			.siblings(".budget-td")
	...
	$(document).on("keyup", ".budget-qty-may", function () {
		...
		var loc = $(this)
			...
			.parent()
			.siblings(".budget-td")
			.find(".weight-unit-may");
		var loc_equivalent = $(this)
			.parent()
			.parent()
			.siblings(".budget-td")
			.find(".equivalent-unit-may");
		var asp = $(this)
			.parent()
			.parent()
			.siblings(".budget-td")
	...
	$(document).on("keyup", ".budget-qty-jun", function () {
		...
		var loc = $(this)
			...
			.parent()
			.siblings(".budget-td")
			.find(".weight-unit-jun");
		var loc_equivalent = $(this)
			.parent()
			.parent()
			.siblings(".budget-td")
			.find(".equivalent-unit-jun");
		var asp = $(this)
			.parent()
			.parent()
			.siblings(".budget-td")
	...
	$(document).on("keyup", ".budget-qty-jul", function () {
		...
		var loc = $(this)
			...
			.parent()
			.siblings(".budget-td")
			.find(".weight-unit-jul");
		var loc_equivalent = $(this)
			.parent()
			.parent()
			.siblings(".budget-td")
			.find(".equivalent-unit-jul");
		var asp = $(this)
			.parent()
			.parent()
			.siblings(".budget-td")
	...
	$(document).on("keyup", ".budget-qty-aug", function () {
		...
		var loc = $(this)
			...
			.parent()
			.siblings(".budget-td")
			.find(".weight-unit-aug");
		var loc_equivalent = $(this)
			.parent()
			.parent()
			.siblings(".budget-td")
			.find(".equivalent-unit-aug");
		var asp = $(this)
			.parent()
			.parent()
			.siblings(".budget-td")
	...
	$(document).on("keyup", ".budget-qty-sep", function () {
		...
		var loc = $(this)
			...
			.parent()
			.siblings(".budget-td")
			.find(".weight-unit-sep");
		var loc_equivalent = $(this)
			.parent()
			.parent()
			.siblings(".budget-td")
			.find(".equivalent-unit-sep");
		var asp = $(this)
			.parent()
			.parent()
			.siblings(".budget-td")
	...
	$(document).on("keyup", ".budget-qty-oct", function () {
		...
		var loc = $(this)
			...
			.parent()
			.siblings(".budget-td")
			.find(".weight-unit-oct");
		var loc_equivalent = $(this)
			.parent()
			.parent()
			.siblings(".budget-td")
			.find(".equivalent-unit-oct");
		var asp = $(this)
			.parent()
			.parent()
			.siblings(".budget-td")
	...
	$(document).on("keyup", ".budget-qty-nov", function () {
		...
		var loc = $(this)
			...
			.parent()
			.siblings(".budget-td")
			.find(".weight-unit-nov");
		var loc_equivalent = $(this)
			.parent()
			.parent()
			.siblings(".budget-td")
			.find(".equivalent-unit-nov");
		var asp = $(this)
			.parent()
			.parent()
			.siblings(".budget-td")
	...
	$(document).on("keyup", ".budget-qty-dec", function () {
		...
		var loc = $(this)
			...
			.parent()
			.siblings(".budget-td")
			.find(".weight-unit-dec");
		var loc_equivalent = $(this)
			.parent()
			.parent()
			.siblings(".budget-td")
			.find(".equivalent-unit-dec");
		var asp = $(this)
			.parent()
			.parent()
			.siblings(".budget-td")
	...
	$(document).on("click", ".slider-opex-btn", function (e) {
		...
		var total_qty = 0;
		$(document)
			.find("#tbl-transac-opex tr")
			.eq(count)
			.find('input[name^="opex"]')
			.each(function () {
	...
	$(document).on("click", ".slider-capex-btn", function (e) {
		...
		$(document)
			.find("#tbl-transac-capex tr")
			.eq(count)
			.find(".capex-total-qty")
			.text(number_format(total));
		$(document)
			.find("#tbl-transac-capex tr")
			.eq(count)
			.find(".capex-total-price")
			.text(number_format(total * price));
	...
	$(document).on("change", "#outlet-trans-year", function (e) {
		...
		var url = base_url + "admin/outlets/" + year;
		window.location = url;
	});
	...
	$(document).on(
		"change",
		"#add-brand-outlet > .form-group > #type",
		function (e) {
			e.preventDefault();
			var id = $(this).val();
			var outlet_id = $("#add-brand-outlet").find("#id").val();
			$.ajax({
				url: base_url + "admin/get-brand-outlet/",
				...
				success: function (response) {
					...
					if (parse_response["result"] == 1) {
						$("#add-brand-outlet > .form-group > #brand")
							.selectize()[0]
							.selectize.destroy();
						$("#add-brand-outlet").find("#brand").empty();
						$("#add-brand-outlet")
							.find("#brand")
							.append(parse_response["info"]);
	...
	$(document).on("click", ".edit-outlet", function (e) {
		e.preventDefault();
		var id = $(this).attr("data-id");
		$.ajax({
			url: base_url + "admin/modal-outlet/",
			data: { id: id },
			method: "POST",
			success: function (response) {
				var parse_response = JSON.parse(response);
				...
				if (parse_response["result"] == 1) {
					var outlet_name = parse_response["info"]["outlet_name"];
					var ifs_code = parse_response["info"]["ifs_code"];
					var bc = parse_response["info"]["bc"];
					var type = parse_response["info"]["type"];
					var status = parse_response["info"]["status"];

					$("#update-outlet").find("#id").val(id);
					$("#update-outlet").find("#edit-ifs-code").val(ifs_code);
					$("#update-outlet").find("#edit-outlet-name").val(outlet_name);
					$("#update-outlet").find("#edit-ifs-code").val(ifs_code);

					$("#update-outlet").find("#edit-outlet-bc").empty();
					$("#update-outlet").find("#edit-outlet-bc").append(bc);

					$("#update-outlet").find("#edit-outlet-status").empty();
					$("#update-outlet").find("#edit-outlet-status").append(status);

					$("#modal-edit-outlet").modal({ show: true });
				} else {
					console.log("Error please contact your administrator");
				}
			},
	...
	$(document).on("click", ".remove-outlet", function (e) {
		e.preventDefault();
		var id = $(this).attr("data-id");
		var year = $("#outlet-year").val();

		$("#remove-outlet").find("#id").val(id);
		$("#remove-outlet-year").val(year);
		$("#modal-remove-outlet").modal({ show: true });
	});
	...
	$(document).on("change", "#brand-bc-trans-year", function (e) {
		...
		var url = base_url + "admin/brand-bc-info/" + bc_id + "/" + year;
		window.location = url;
	});
	...
	$(document).on("click", ".edit-material", function (e) {
		...
		$.ajax({
			url: base_url + "admin/modal-material/" + id,
			method: "GET",
			success: function (response) {
				var parse_response = JSON.parse(response);
				...
				if (parse_response["result"] == 1) {
					...
					$("#update-material")
						.find("#material-code")
						.val(parse_response["info"].material_code);
					console.log(parse_response["info"].material_code);
					$("#update-material")
						.find("#description")
						.val(parse_response["info"].material_desc);
					$("#update-material").find("#group").empty();
					$("#update-material")
						.find("#group")
						.append(parse_response["info"].group);
					...
					$("#update-material")
						.find("#base-unit")
						.append(parse_response["info"].base_unit);

					$("#update-material")
						.find("#valuation-unit")
						.append(parse_response["info"].valuation_unit);

					$("#update-material")
						.find("#valuation-basis")
						.val(parse_response["info"].valuation_basis);

					$("#update-material")
						.find("#equivalent-unit")
						.val(parse_response["info"].sales_equivalent);
					$("#update-material")
						.find("#material-weight")
						.val(parse_response["info"].material_weight);

					$("#update-material")
						.find("#edit-allocation")
						.selectize()[0]
						.selectize.destroy();
					$("#update-material").find("#edit-allocation").empty();
					$("#update-material")
						.find("#edit-allocation")
						.append(parse_response["info"].allocation);
	...
	$(document).on("click", ".edit-group", function (e) {
		...
		var id = $(this).attr("data-id");
		$.ajax({
			url: base_url + "admin/modal-group/",
			data: { id: id },
			method: "POST",
			success: function (response) {
				var parse_response = JSON.parse(response);
	...
	$(document).on("change", "#capex-trans-year", function (e) {
		...
		var url = base_url + "admin/capex-info/" + bc_id + "/" + year;
		window.location = url;
	});
	...
	$(document).on("change", "#capex-ag", function () {
		...
		$.ajax({
			url: base_url + "admin/get-subgroup/",
	...
	$(document).on("click", ".add-asset-sub", function (e) {
		...
		$.ajax({
			url: base_url + "admin/get-asset-subgroup/",
	...
	$(document).on("keyup", ".capex-qty", function (e) {
		...
		var total = parseFloat(
			$(this).parent().parent().find(".capex-total-price").text()
		);
		...
		if ($.isNumeric(val) || val == "") {
			if (Math.floor(val) >= 0) {
				var total_qty = 0;
				total_qty +=
					parseFloat($(this).parent().parent().find(".jan-qty").val()) || 0;
				total_qty +=
					parseFloat($(this).parent().parent().find(".feb-qty").val()) || 0;
				total_qty +=
					parseFloat($(this).parent().parent().find(".mar-qty").val()) || 0;
				total_qty +=
					parseFloat($(this).parent().parent().find(".apr-qty").val()) || 0;
				total_qty +=
					parseFloat($(this).parent().parent().find(".may-qty").val()) || 0;
				total_qty +=
					parseFloat($(this).parent().parent().find(".jun-qty").val()) || 0;
				total_qty +=
					parseFloat($(this).parent().parent().find(".jul-qty").val()) || 0;
				total_qty +=
					parseFloat($(this).parent().parent().find(".aug-qty").val()) || 0;
				total_qty +=
					parseFloat($(this).parent().parent().find(".sep-qty").val()) || 0;
				total_qty +=
					parseFloat($(this).parent().parent().find(".oct-qty").val()) || 0;
				total_qty +=
					parseFloat($(this).parent().parent().find(".nov-qty").val()) || 0;
				total_qty +=
					parseFloat($(this).parent().parent().find(".dec-qty").val()) || 0;
				...
				$(this)
					...
					.parent()
					.find(".capex-total-price")
					.text(number_format(total_price));
	...
	$(document).on("click", ".update-trans-item", function (e) {
		...
		$.ajax({
			url: base_url + "admin/get-capex-item/",
			data: { id: id },
			method: "POST",
			success: function (response) {
				var parse_response = JSON.parse(response);
				if (parse_response["result"] == 1) {
					...
					if (asset_group == "TRANSPORTATION EQUIPMENT") {
						...
						$("#edit-capex-remarks").append(
							'<label>Remarks: </label><input type="text" name="remarks" class="form-control input-sm" value="' +
								remarks +
								'">'
						);
					}
	...
	$(document).on("change", "#opex-trans-year", function (e) {
		...
		var url = base_url + "admin/opex-info/" + bc_id + "/" + year;
		window.location = url;
	});
	...
	$(document).on("change", "#opex-brand", function () {
		...
		var bc_id = $("#cost-center").val();
		var year = $("#opex-year").val();
		var url =
			base_url +
			"admin/download-store-expense/" +
			bc_id +
			"/" +
			brand +
			"/" +
	...
	$("#add-opex-form")
		.find("#opex-brand-specific-group")
		.change(function () {
			var id = $(this).val();
			var cost_center = $("#cost-center").val();
			var year = $("#opex-year").val();
		...
		if ($.isNumeric(qty) || qty == "") {
			if (Math.floor(qty) >= 0) {
				...
				$(this)
					...
					.parent()
					.find(".opex-total-qty")
					.text(number_format(total_qty, 2));
	...
	$("#add-opex-form").submit(function (e) {
		...
		if (check && check_cc) {
			//check of modal is already open allow submit form
			var check_modal = ($("#modal-confirm-opex").data("bs.modal") || {})
				.isShown;
			if (!check_modal) {
				e.preventDefault();
	...
	$(document).on("click", ".update-opex-item", function (e) {
		...
		var cost_center = $("#cost-center").val();
		$.ajax({
			url: base_url + "admin/get-opex-item/",
			data: { id: id, cost_center: cost_center },
			method: "POST",
			success: function (response) {
				var parse_response = JSON.parse(response);
	...
	$(document).on("click", ".update-sw-item", function (e) {
		...
		var id = $(this).attr("data-id");
		$.ajax({
			url: base_url + "admin/get-sw-item/",
			data: { id: id },
			method: "POST",
			success: function (response) {
				var parse_response = JSON.parse(response);
	...
	$(document).on("change", "#emp-trans-year", function (e) {
		...
		var url = base_url + "admin/employees/" + year;
		window.location = url;
	});
	...
	$(document).on("change", "#emp-type", function () {
		...
		if (type == "NEW") {
			$.ajax({
				url: base_url + "admin/get-new-emp/",
				method: "GET",
				success: function (response) {
					var parse_response = JSON.parse(response);
					if (parse_response["result"] == 1) {
	...
	$(document).on("change", "#emp-unit", function () {
		...
		if (unit !== "") {
			$.ajax({
				url: base_url + "admin/get-emp-cost-center/",
				method: "POST",
				data: { unit: unit },
				success: function (response) {
					var parse_response = JSON.parse(response);
	...
	$(document).on("click", ".edit-emp", function (e) {
		...
		var id = $(this).attr("data-id");
		$.ajax({
			url: base_url + "admin/modal-employee/",
			data: { id: id },
			method: "POST",
			success: function (response) {
				var parse_response = JSON.parse(response);
	...
	$(document).on("change", "#manpower-trans-year", function (e) {
		...
		var url = base_url + "admin/manpower/" + year;
		window.location = url;
	});

	$("#manpower-type").on("change", function () {
		var type = $(this).val();

		if (type == "bc") {
			$("#div-manpower-unit").addClass("hide");
			$("#div-manpower-bc").removeClass("hide");
		} else if (type == "sc") {
			$("#div-manpower-bc").addClass("hide");
			$("#div-manpower-unit").removeClass("hide");

			$("#bc-old").addClass("hide");
			$("#bc-new").addClass("hide");
			$("#bc-old").removeClass("hide");
			$("#bc-new").removeClass("hide");
		}
	});

	$("#manpower-bc").on("change", function () {
		var bc = $(this).val();

		if (bc !== "") {
			$.ajax({
				url: base_url + "admin/get-manpower-bc-cost-center/",
				method: "POST",
				data: { bc: bc },
				success: function (response) {
					var parse_response = JSON.parse(response);
					if (parse_response["result"] == 1) {
						var cost_center = parse_response["info"];
						$("#manpower-cost-center").empty();
						$("#manpower-cost-center").append(cost_center);
					} else {
						console.log("Error please contact your administrator");
					}
				},
	...
	$("#manpower-unit").on("change", function () {
		var unit = $(this).val();

		if (unit !== "") {
			$.ajax({
				url: base_url + "admin/get-manpower-sc-cost-center/",
				method: "POST",
				data: { unit: unit },
				success: function (response) {
					var parse_response = JSON.parse(response);
		...
		$.ajax({
			...
			success: function (response) {
				...
				if (parse_response["result"] == 1) {
					...
					$("#update-manpower")
						.find("#edit-manpower-cost-center")
						.append(cost_center);
					...
					$("#update-manpower")
						.find("#edit-manpower-bc-old")
						.val(manpower_bc_old);
					$("#update-manpower")
						.find("#edit-manpower-bc-new")
						.val(manpower_bc_new);
	...
	$(document).on("change", "#alw-trans-year", function (e) {
		...
		var url = base_url + "admin/live-alw/" + year;
		window.location = url;
	});
	...
	$(document).on("change", "#tactical-trans-year", function (e) {
		...
		var id = $("#cost-center").val();

		var url = base_url + "admin/tactical-info/" + id + "/" + year;
		window.location = url;
	});
	...
	$(document).on("change", "#add-tactical-price #brand", function () {
		...
		if (brand !== "") {
			$.ajax({
				url: base_url + "admin/get-tactical-price-store/",
				method: "POST",
	...
	$(document).on("click", ".slider-tactical-btn", function (e) {
		...
		$("#modal-slider-tactical").modal("hide");
		$("#update-tactical-price").bootstrapValidator(
			"revalidateField",
			"jan_qty"
		);
		$("#update-tactical-price").bootstrapValidator(
	...
	$(document).on("click", ".edit-tactical", function (e) {
		...
		if (id !== "") {
			$.ajax({
				url: base_url + "admin/get-tactical/",
				method: "POST",
				data: { id: id },
				success: function (response) {
					var parse_response = JSON.parse(response);
	...
	$(document).on("change", "#lock-type", function () {
		var type = $(this).val();
		var url = base_url + "admin/get-lock-location";
		...
		$.ajax({
			...
			success: function (response) {
				...
				if (parse_response["result"] == 1) {
					$("#add-lock-module").find("#lock-location").empty();
					$("#add-lock-module")
						.find("#lock-location")
						.append(parse_response["info"]);
					$("#update-measurement")
	...
	$(document).on("click", ".unlocked", function (e) {
		e.preventDefault();
		var id = $(this).attr("data-id");
		$("#update-lock-module").find("#id").val(id);
		$("#modal-lock").modal({ show: true });
	});

	$(document).on("click", ".locked", function (e) {
		e.preventDefault();
		var id = $(this).attr("data-id");
		$("#update-unlock-module").find("#id").val(id);
		$("#modal-unlock").modal({ show: true });
	});
	...
	$("#cost-center-allocation").selectize({
		maxItems: 100,
		valueField: "id",
		labelField: "title",
		searchField: "title",
	...
	$(document).on("click", ".edit-cost-center", function (e) {
		...
		$.ajax({
			url: base_url + "admin/modal-cost-center/" + id,
			method: "GET",
			success: function (response) {
				var parse_response = JSON.parse(response);

				if (parse_response["result"] == 1) {
					$("#update-cost-center").find("#id").val(id);
					$("#update-cost-center")
						.find("#edit-cost-center-code")
						.val(parse_response["info"].cost_center_code);
					$("#update-cost-center")
						.find("#edit-cost-center-name")
						.val(parse_response["info"].cost_center_name);
					$("#update-cost-center").find("#edit-cost-center-bc").empty();
					$("#update-cost-center")
						.find("#edit-cost-center-bc")
						.append(parse_response["info"].bc);
					$("#update-cost-center").find("#edit-cost-center-unit").empty();
					$("#update-cost-center")
						.find("#edit-cost-center-unit")
						.append(parse_response["info"].company_unit);
					$("#update-cost-center").find("#edit-cost-center-type").empty();
					$("#update-cost-center")
						.find("#edit-cost-center-type")
						.append(parse_response["info"].cost_center_type);

					$("#update-cost-center").find("#edit-cost-center-group").empty();
					$("#update-cost-center")
						.find("#edit-cost-center-group")
						.append(parse_response["info"].cost_center_group);
					$("#update-cost-center").find("#edit-cost-center-type").empty();
					$("#update-cost-center")
						.find("#edit-cost-center-type")
						.append(parse_response["info"].cost_center_type);

					$("#update-cost-center").find("#edit-cost-center-allocation").empty();
					$("#update-cost-center")
						.find("#edit-cost-center-allocation")
						.append(parse_response["info"].allocation_type);

					$("#modal-edit-cost-center").modal({ show: true });
					$("#update-cost-center").bootstrapValidator("resetForm");
				} else {
					console.log("Error please contact your administrator.");
				}
			},
	...
	// $("#add-commissary").bootstrapValidator({
	// 	framework: 'bootstrap',
	// 	excluded: [':disabled'],
	// 	fields:{
	// 		commissary_name: {
	// 			validators: {
	// 				notEmpty: {
	// 					message: 'Commissary Name is required!'
	// 				}
	// 			}
	// 		},
	...
	// 			validators: {
	// 				notEmpty: {
	// 					message: 'Commissary Location is required!'
	// 				}
	// 			}
	// 		},
	...
	// 			validators: {
	// 				notEmpty: {
	// 					message: 'Commissary address is required!'
	// 				}
	// 			}
	// 		},
	...
	$(document).on("change", "#opex-gl-class", function () {
		...
		$.ajax({
			url: base_url + "admin/get-gl-base-on-class/" + id + "/" + cost_center,
			// data: {id:id, cost_center:cost_center},
			method: "GET",
			beforeSend: function () {
				// setting a timeout
				var loading_table =
					'<tr><td colspan="16">Loading, Please wait...</td></td>';
				$("#tbl-transac-opex > tbody").empty();
			...
			success: function (response) {
				...
				if (parse_response["result"] == 1) {
					...
					$("#tbl-transac-opex > tbody").empty();
					var loading_table =
						'<tr><td colspan="16">Too many data, Please use the upload function.</td></td>';
					// $("#tbl-transac-opex > tbody").append(parse_response['gl']);
					$("#tbl-transac-opex > tbody").append(loading_table);
					// tbl_transac_opex = $('#tbl-transac-opex').DataTable({
					// 	"scrollX": true,
	...
	$("#commi-cost-sheet-stat").selectize({
		maxItems: 1,
		valueField: "id",
		labelField: "title",
		searchField: "title",
	...
	$(document).on("change", "#commi-cost-sheet-stat", function (e) {
		e.preventDefault();
		var id = $(this).val();
		var commissary_id = $("#commissary_id").val();
		...
		$.ajax({
			url: base_url + "admin/get-commi-cost-sheet-materials/",
			data: { id: id, commissary_id: commissary_id, year: year },
			method: "POST",
			success: function (response) {
				...
				if (parse_response["result"] == 1) {
					...
					$("#prod_trans_list").selectize()[0].selectize.destroy();
					$("#prod_trans_list").empty();
					$("#prod_trans_list").append(parse_response["info"]);

					$("#prod_trans_list").selectize({
						maxItems: 30,
						valueField: "id",
						labelField: "title",
						searchField: "title",
	...
	$("#tbl-commi-mat-cost").DataTable({
		bInfo: false,
		order: [],
	});

	$("#tbl-commissary").DataTable({
		bInfo: false,
		order: [],
	});

	$("#bc_id_to_serve").select2({
		width: "100%",
	});

	$(document).on("click", ".cancel-commissary", function (e) {
		e.preventDefault();
		var commissary_id = $(this).attr("data-id");

		$("#cancel-commissary").find("#commissary_id").val(commissary_id);
		$("#cancel-commissary")
			.find("#modal-msg")
			.html("Are you sure to deactivate this commissary?");
		$("#cancel-commissary").find("#trans_status").val("cancel");
		$("#modal-confirm-commissary").modal({ show: true });
	});

	$(document).on("click", ".activate-commissary", function (e) {
		e.preventDefault();
		var commissary_id = $(this).attr("data-id");
		...
		$("#cancel-commissary")
			.find("#modal-msg")
			.html("Are you sure to activate this commissary?");
		$("#cancel-commissary").find("#trans_status").val("activate");
		$("#modal-confirm-commissary").modal({ show: true });
	});

	$(document).on("click", ".edit-commissary", function (e) {
		e.preventDefault();
		var commissary_id = $(this).attr("data-id");

		$.ajax({
			url: base_url + "admin/get-commissary",
			...
			success: function (response) {
				...
				if (parse_response["result"] == 1) {
					$("#add-commissary").find("#commissary_id").val(commissary_id);
					$("#add-commissary")
						.find("#commissary_name")
						.val(parse_response["info"].commissary_name);
					$("#add-commissary")
						.find("#commissary_location")
						.val(parse_response["info"].commissary_location);
					$("#add-commissary")
						.find("#commissary_capacity")
						.val(parse_response["info"].commissary_capacity);
					$("#add-commissary")
						.find("#commissary_cost_center_code")
						.val(parse_response["info"].commissary_cost_center_code);
					$("#add-commissary")
						.find("#commissary_address")
						.val(parse_response["info"].commissary_address);
					$("#add-commissary")
						.find("#bc_id_to_serve")
						.empty()
						.append(parse_response["info"].data_bc);
					$("#add-commissary")
						.find("#commi-cap-to-replace")
						.empty()
						.append(parse_response["info"].data_commi_cap);

					$("#add-commissary").attr(
						"action",
						base_url + "admin/update-commissary"
					);

					$("#add-commissary").find(".commi-form-btn").html("Update");
					$("#modal-commissary").modal({ show: true });
				} else {
					console.log("Error please contact your administrator");
				}
			},
	...
	$(document).on("change", "#commi_config_prod", function () {
		var id = $(this).val();
		var commissary_id = $("#commissary_id").val();
		var pick_year = $("#pick_year").val();
		var brand_id = $("#brand_id").val();
		var process_selected = $("#commi_config_prod option:selected").text();
		var process_selected = process_selected.split("~");
		$("#process_type_name").val(process_selected[1]);
		$.ajax({
			url: base_url + "admin/get-config-prod",
			data: {
				id: id,
				commissary_id: commissary_id,
				pick_year: pick_year,
				process_type_name: process_selected[1],
				brand_id: brand_id,
			},
			method: "POST",
			success: function (response) {
				...
				if (parse_response["result"] == 1) {
					...
					for (var i = 1; i <= 12; i++) {
						$("#tbl-new-prod-transaction")
							.find("#dynamic_hdr-" + i)
							.html("Cost");
					}
					$("#modal-slider-prod").find("#dynamic-label").html("Cost");
					if (parse_response["config_prod"] == "No data") {
						...
						$("#tbl-new-prod-transaction > tbody").append(
							parse_response["config_prod"]
						);
						tbl_transac_prod = $("#tbl-new-prod-transaction").DataTable({
							order: [],
							scrollX: true,
	...
	$("#commi-prod-trans-year")
		...
		return;*/
			...
			$.ajax({
				url: base_url + "admin/get-commi-prod-trans",
				data: { prod_trans_date: year, commissary_id: commissary_id },
				method: "POST",
				success: function (response) {
					/*console.log(response);
	    		return;*/
					...
					if (parse_response["result"] == 1) {
						...
						if (parse_response["pending_lock_status"]) {
							...
							$("#add_prod_trans_button").attr(
								"href",
								base_url +
									"admin/new-commi-prod-trans/" +
									commissary_id +
									"/" +
									year
							);
							$("#view_cost_sheet_button").attr(
								"href",
								base_url +
									"admin/view-commi-cost-sheet-report/" +
									commissary_id +
									"/" +
									year
							);
	...
	$(document).on("paste", "#tbl-add-broiler-config input", function (e) {
		$this = $(this);
		setTimeout(function () {
			var columns = $this.val().trim().replace(/,/g, "").split(/\s+/);
			var i;
			...
			success: function (response) {
				...
				if (parse_response["result"] == 1) {
					...
					if (parse_response["broiler_group"] == "No data") {
						...
						$("#tbl-new-broiler-transaction > tbody").append(
							parse_response["broiler_group"]
						);
						tbl_transac_broiler = $("#tbl-new-broiler-transaction").DataTable({
							scrollX: true,
							autoWidth: true,
		...
		$.ajax({
			...
			success: function (response) {
				...
				if (parse_response["result"] == 1) {
					tbl_transac_prod.destroy();
					$("#tbl-new-prod-transaction > tbody").empty();
					// console.log(process_selected[1].trim());
	...
	var tbl_industry_dashboard_trans = $(
		"#tbl-industry-dashboard-trans"
	).DataTable({
		bInfo: false,
		order: [],
		paging: false,
	...
	var tbl_sales_commission_maintenance = $(
		"#tbl-sales-commission-maintenance"
	).DataTable({
		bInfo: false,
		order: [],
	});
	...
	var tbl_percent_rent_maintenance = $(
		"#tbl-percent-rent-maintenance"
	).DataTable({
		bInfo: false,
		order: [],
	});
	...
	$("#broiler-budget-date-year")
		...
		.on("changeDate", function (e) {
			...
			var url = base_url + "admin/broiler-trans/" + bc_id + "/" + year;
			window.location.replace(url);
		});

	$("#broiler-actual-data-year")
		.datepicker({
			autoclose: true,
			format: "yyyy",
			viewMode: "years",
			...
			$.ajax({
				...
				success: function (response) {
					...
					if (parse_response["result"] == 1) {
						...
						$("#tbl-other-trans > tbody").append(
							parse_response["broiler_amount_item"]
						);
						...
						if (parse_response["pending_lock_status"]) {
							$("#add_broiler_actual_data").show();
							$("#add_broiler_actual_data").attr(
								"href",
								base_url +
									"admin/new-broiler-amount-summary/" +
									bc_id +
									"/" +
									year
							);
			...
			$.ajax({
				...
				success: function (response) {
					...
					if (parse_response["result"] == 1) {
						...
						$("#tbl-view-broiler-config > tbody").append(
							parse_response["broiler_config_item"]
						);
						...
						if (parse_response["pending_lock_status"]) {
							$("#add_broiler_config_button").show();
							$("#add_broiler_config_button").attr(
								"href",
								base_url + "admin/new-broiler-config/" + bc_id + "/" + year
							);
						} else {
							$("#add_broiler_config_button").hide();
						}
			...
			$.ajax({
				...
				success: function (response) {
					...
					if (parse_response["result"] == 1) {
						...
						$("#tbl-broiler-trans > tbody").append(
							parse_response["broiler_trans"]
						);
						...
						if (parse_response["pending_lock_status"]) {
							$("#add_broiler_trans_button").show();
							$("#add_broiler_trans_button").attr(
								"href",
								base_url + "admin/new-broiler-trans/" + bc_id + "/" + year
							);

							$("#view_broiler_summary").show();
							$("#view_broiler_summary").attr(
								"href",
								base_url + "admin/view-broiler-summary/" + bc_id + "/0/" + year
							);
						} else {
							$("#add_broiler_trans_button").hide();
							$("#view_broiler_summary").hide();
			...
			$.ajax({
				...
				success: function (response) {
					...
					if (parse_response["result"] == 1) {
						...
						$("#tbl-add-broiler-config > tbody").append(
							parse_response["broiler_line_item"]
						);
	...
	$("#prod-trans-year")
		...
		return;*/
			...
			$.ajax({
				url: base_url + "admin/get-prod-trans",
	    		...
	    		return;*/
					...
					if (parse_response["result"] == 1) {
						...
						if (parse_response["pending_lock_status"]) {
							...
							$("#add_prod_trans_button").attr(
								"href",
								base_url + "admin/new-prod-trans/" + bc_id + "/" + year
							);
							$("#view_cost_sheet_button").attr(
								"href",
								base_url + "admin/view-cost-sheet-report/" + bc_id + "/" + year
							);
						} else {
							$("#add_prod_trans_button").hide();
							$("#copy_prod_trans_button").hide();
					...
					if (parse_response["result_2"] == 1) {
						...
						$("#tbl-prod-trans-external > tbody").append(
							parse_response["ext_prod_trans"]
						);
						...
						if (parse_response["pending_lock_status_2"]) {
							...
							$(".remove-commi-mat-cost").show();
							$("#edit_ext_prod_trans_button").show();
							$("#add_ext_transaction").attr(
								"href",
								base_url + "admin/new-ext-prod-trans/" + bc_id + "/" + year
							);
							$("#add_commi_mat_cost_trans").attr(
								"href",
								base_url + "admin/new-commmi-mat-cost/" + bc_id + "/" + year
							);
							$("#view_ext_transaction").attr(
								"href",
								base_url + "admin/view-ext-prod-trans/" + bc_id + "/" + year
							);
						} else {
							$("#add_ext_material").hide();
							$("#add_commi_mat_cost").hide();
	...
	$("#sales-bom-trans-year")
		...
		return;*/
			...
			$.ajax({
				url: base_url + "admin/get-sales-bom-trans",
				data: { prod_trans_date: year, bc_id: bc_id },
				method: "POST",
				success: function (response) {
					/*console.log(response);
	    		return;*/
					...
					if (parse_response["result"] == 1) {
						...
						if (parse_response["pending_lock_status"]) {
							...
							$("#add_sales_bom_trans_button").attr(
								"href",
								base_url + "admin/new-sales-bom-trans/" + bc_id + "/" + year
							);
							$("#view_sales_bom_summary_button").attr(
								"href",
								base_url + "admin/view-sales-bom-summary/" + bc_id + "/" + year
							);
							$("#create_by_product_on_sales_bom").attr(
								"href",
								base_url +
									"admin/create-by-product-on-sales-bom/" +
									bc_id +
									"/" +
									year
							);
							$("#resync_bom_summary").attr(
								"href",
								base_url + "admin/resync-bom-summary/" + bc_id + "/" + year
							);
						} else {
							$("#create_by_product_on_sales_bom").hide();
							$("#add_sales_bom_trans_button").hide();
	...
	$(document).on("click", ".remove-sales-commission", function (e) {
		...
		$("#remove-sales-commission")
			.find("#sales_commission_id")
			.val(sales_commission_id);
		$("#remove-sales-commission")
			.find("#modal-msg")
			.html(
	...
	$(document).on("click", ".remove-prod-trans", function (e) {
		...
		var commissary_id = $(this).attr("data-commissary_id");
		...
		$("#remove-prod-trans").find("#commissary_id").val(commissary_id);
		$("#remove-prod-trans")
			.find("#modal-msg")
			.html("Are you sure to cancel this transaction?");
	...
	$(document).on("click", ".cancel-commparative-data", function (e) {
		...
		$("#cancel-comparative-data")
			.find("#modal-msg")
			.html("Are you sure to cancel this upload?");
	...
	$(document).on("click", ".cancel-broiler-amount-summary", function (e) {
		...
		$("#cancel-broiler-amount-summary")
			.find("#broiler_line_item_id")
			.val(broiler_line_item_id);
	...
	$(document).on("click", ".cancel-industry-trans", function (e) {
		...
		$("#cancel-industry-trans")
			.find("#industry_trans_id")
			.val(industry_trans_id);
	...
	$(document).on("click", ".remove-ext-prod-trans", function (e) {
		...
		$("#remove-ext-prod-trans")
			.find("#ext_prod_trans_id")
			.val(ext_prod_trans_id);
	...
	$(document).on("click", ".remove-commi-mat-cost", function (e) {
		e.preventDefault();
		var commi_mat_cost_id = $(this).attr("data-id");
		var commissary_id = $(this).attr("data-commissary_id");

		$("#remove-ext-prod-trans")
			.find("#commi_mat_cost_id")
			.val(commi_mat_cost_id);
		$("#remove-ext-prod-trans").find("#commissary_id").val(commissary_id);
		$("#remove-ext-prod-trans")
			.find("#modal-msg")
			.html("Are you sure to cancel this configuration?");
		$("#remove-ext-prod-trans").find("#trans_status").val("cancel");
		$("#modal-confirm_2").modal({ show: true });
	});
	...
	$(document).on("click", ".cancel-broiler-trans", function (e) {
		...
		$("#post-broiler-trans")
			.find("#modal-msg")
			.html("Are you sure to cancel this transaction details?");
		$("#modal-confirm").modal({ show: true });
	});
	...
	$(document).on("change", "#cost-sheet-stat", function (e) {
		e.preventDefault();
		var id = $(this).val();
		var bc_id = $("#bc_id").val();
		var year = $("#prod-trans-date-pick-year").val();
		...
		$.ajax({
			url: base_url + "admin/get-cost-sheet-materials/",
			data: { id: id, bc_id: bc_id, year: year },
			method: "POST",
			success: function (response) {
				/*console.log(parse_response);
	    		return;*/
	...
	$(document).on("click", "#ext_batch_cancellation", function (e) {
		...
		$.ajax({
			url: base_url + "admin/get-ext-prod-materials/",
	...
	$(document).on("click", "#commi_mat_cost_batch_cancellation", function (e) {
		e.preventDefault();
		//var id = $(this).val();
		var commissary_id = $("#commissary_id").val();
		var year = $("#prod-trans-date-pick-year").val();
		...
		$(formID).find("#commissary_id").val(commissary_id);

		$.ajax({
			url: base_url + "admin/get-commi-mat-cost-materials/",
			data: { commissary_id: commissary_id, year: year },
			method: "POST",
			success: function (response) {
				/*console.log(parse_response);
	    		return;*/
				...
				if (parse_response["result"] == 1) {
					...
					$(formID)
						...
						.selectize()[0]
						.selectize.destroy();
					$(formID).find("#commi_mat_cost_id").empty();
					$(formID).find("#commi_mat_cost_id").append(parse_response["info"]);
					$(formID).find("#commi_mat_cost_id").selectize({
						maxItems: 30,
						valueField: "id",
						labelField: "title",
						searchField: "title",
	...
	$(document).on("click", ".slider-prod-btn", function (e) {
		...
		$(document)
			.find("#tbl-new-broiler-transaction tr")
			.eq(count)
		...
		$(document)
			.find("#tbl-new-prod-transaction tr")
			.eq(count)
			.find('input[name^="rate"]')
			.each(function () {
				if (qty_start <= counter_qty && qty_end >= counter_qty) {
	...
	$(document).on("click", ".slider-broiler-btn", function (e) {
		...
		$(document)
			.find("#tbl-add-broiler-config tr")
			.eq(count)
			.find('input[name^="config_qty"]')
			.each(function () {
				if (qty_start <= counter_qty && qty_end >= counter_qty) {
					$(this).val("");
					$(this).val(qty);
		...
		$(document)
			.find("#tbl-view-broiler-transaction tr")
			.eq(count)
			.find('input[name^="broiler_budget_qty"]')
			.each(function () {
				if (qty_start <= counter_qty && qty_end >= counter_qty) {
					$(this).val("");
					$(this).val(qty);
		...
		$(document)
			.find("#tbl-edit-sales-commission tr")
			.eq(count)
			.find('input[name^="sales_commission_det_value"]')
			.each(function () {
				if (qty_start <= counter_qty && qty_end >= counter_qty) {
					$(this).val("");
					$(this).val(qty);
		...
		$(document)
			.find("#tbl-edit-percent-rent tr")
			.eq(count)
			.find('input[name^="percent_rent_det_value"]')
			.each(function () {
				if (qty_start <= counter_qty && qty_end >= counter_qty) {
					$(this).val("");
					$(this).val(qty);
