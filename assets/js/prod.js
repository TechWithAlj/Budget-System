...
$(document).ready(function(){
	...
	$(document).on('change', '#broiler_group', function(){
		...
		var bc_id = $('#bc_id').val();
		$.ajax({
	    	url: base_url + 'production/get-broiler-subgroup',
	...
	$(document).on('change', '#config_prod', function(){
		...
		$.ajax({
	    	url: base_url + 'production/get-config-prod',
	...
	$('#tbl-prod-trans-external').DataTable({
		"bInfo" : false,
		"order": []
	});

	$('#tbl-new-ext-prod').DataTable({
		"order": [],
		"scrollX": true,
		"autoWidth": true,
		"bInfo" : false,
	...
	$('#broiler-trans-year').datepicker({
		...
		$.ajax({
	    	url: base_url + 'production/get-broiler-trans',
	...
	$('#prod-trans-year').datepicker({
		...
		$.ajax({
	    	url: base_url + 'production/get-prod-trans',
	...
	$('#sales-bom-trans-year').datepicker({
		...
		$.ajax({
	    	url: base_url + 'production/get-sales-bom-trans',
	    	data: {prod_trans_date:year, bc_id:bc_id},
	    	method: 'POST',
	    	success:function(response){
	    		/*console.log(response);
	...
	$(document).on('change', '#type_id', function(e){
		...
		var id = $(this).val();
		$.ajax({
	    	url: base_url + 'production/get-brand/',
	    	data:{id:id},
	    	method: 'POST',
	    	success:function(response){
	    		var parse_response = JSON.parse(response);
	...
	$(document).on('change', '#component_type_id', function(e){
		...
		var id = $(this).val();
		$.ajax({
	    	url: base_url + 'production/get-material/',
	    	data:{id:id},
	    	method: 'POST',
	    	success:function(response){
	    		var parse_response = JSON.parse(response);
    ...
    $(document).on('change', '#component_type_id_svc', function(e){
		...
		$.ajax({
	    	url: base_url + 'production/get-services/',
	    	data:{id:id},
	    	method: 'POST',
	    	success:function(response){
	    		/*console.log(parse_response);
